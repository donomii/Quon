...
if (globalTrace)
    printf("imaDeclarations at q/imaginary.qon:40 (%s)\n", caller);
...
if (globalTrace)
    printf("imaExpressionStart at q/imaginary.qon:59 (%s)\n", caller);
...
if (globalTrace)
    printf("imaExpression at q/imaginary.qon:101 (%s)\n", caller);
...
if (globalTrace)
  ...
  if ( isNil(program)) {
if (globalTrace)
    snprintf(caller, 1024, "from q/imaginary.qon:105");
    if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);
...
if (globalTrace)
    ...
    if ( isList(program)) {
if (globalTrace)
    snprintf(caller, 1024, "from q/imaginary.qon:109");
      if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);
...
if (globalTrace)
    printf("imaStatement at q/imaginary.qon:130 (%s)\n", caller);
...
if (globalTrace)
    printf("imaBody at q/imaginary.qon:186 (%s)\n", caller);
...
if (globalTrace)
    printf("imaFunctions at q/imaginary.qon:198 (%s)\n", caller);

if (globalTrace)
    snprintf(caller, 1024, "from q/imaginary.qon:200");
  if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);
...
if (globalTrace)
    printf("imaTypeDecl at q/imaginary.qon:208 (%s)\n", caller);
...
if (globalTrace)
    printf("imaStructComponents at q/imaginary.qon:233 (%s)\n", caller);

if (globalTrace)
    snprintf(caller, 1024, "from q/imaginary.qon:235");
  if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);

  if ( isEmpty(node)) {
if (globalTrace)
    snprintf(caller, 1024, "from q/imaginary.qon:236");
    if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);
...
if (globalTrace)
    printf("imaStruct at q/imaginary.qon:239 (%s)\n", caller);
...
if (globalTrace)
    printf("imaTypeMap at q/imaginary.qon:242 (%s)\n", caller);
...
if (globalTrace)
    printf("imaType at q/imaginary.qon:254 (%s)\n", caller);
...
if (globalTrace)
    printf("imaTypes at q/imaginary.qon:269 (%s)\n", caller);
...
if (globalTrace)
    printf("imaProgram at q/imaginary.qon:279 (%s)\n", caller);
...
if (globalTrace)
    printf("imaIncludes at q/imaginary.qon:289 (%s)\n", caller);
...
if (globalTrace)
    printf("imaCompile at q/imaginary.qon:296 (%s)\n", caller);
...
if (globalTrace)
    snprintf(caller, 1024, "from q/lua.qon:102");
      if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);
...
if (globalTrace)
    snprintf(caller, 1024, "from q/lua.qon:115");
  if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);
...
if (globalTrace)
    snprintf(caller, 1024, "from q/lua.qon:168");
  if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);
...
if (globalTrace)
  ...
  if ( isNil(node)) {
if (globalTrace)
    snprintf(caller, 1024, "from q/java.qon:172");
    if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);
...
if (globalTrace)
    snprintf(caller, 1024, "from q/java.qon:194");
    if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);
...
if (globalTrace)
  ...
  if ( isEmpty(tree)) {
if (globalTrace)
    snprintf(caller, 1024, "from q/java.qon:209");
    if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);
...
if (globalTrace)
  ...
  if ( isEmpty(node)) {
if (globalTrace)
    snprintf(caller, 1024, "from q/java.qon:255");
    if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);
...
if (globalTrace)
    snprintf(caller, 1024, "from q/java.qon:281");
  if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);
...
if (globalTrace)
    snprintf(caller, 1024, "from q/java.qon:292");
    if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);
...
if (globalTrace)
    snprintf(caller, 1024, "from q/java.qon:331");
      if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);
...
//Building function javaTypes from line: 335

void javaTypes(list nodes) {
  
if (globalTrace)
    printf("javaTypes at q/java.qon:335 (%s)\n", caller);
...
//Building function javaCompile from line: 341
...
if (globalTrace)
    printf("javaCompile at q/java.qon:341 (%s)\n", caller);
...
if (globalTrace)
    snprintf(caller, 1024, "from q/java.qon:372");
  if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);
...
if (globalTrace)
  ...
  if ( isEmpty(tree)) {
if (globalTrace)
    snprintf(caller, 1024, "from q/node.qon:217");
    if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);
...
if (globalTrace)
    printf("nodeTypeDecl at q/node.qon:264 (%s)\n", caller);
...
if (globalTrace)
    printf("nodeStructComponents at q/node.qon:281 (%s)\n", caller);
...
if (globalTrace)
    printf("nodeStruct at q/node.qon:289 (%s)\n", caller);

if (globalTrace)
    snprintf(caller, 1024, "from q/node.qon:292");
  if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);
...
if (globalTrace)
    printf("nodeTypeMap at q/node.qon:294 (%s)\n", caller);
...
if (globalTrace)
    snprintf(caller, 1024, "from q/node.qon:306");
    if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);
...
if (globalTrace)
    printf("nodeFuncMap at q/node.qon:309 (%s)\n", caller);

if (globalTrace)
    snprintf(caller, 1024, "from q/node.qon:312");
  if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);
...
if (globalTrace)
    snprintf(caller, 1024, "from q/node.qon:339");
    if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);
...
if (globalTrace)
    printf("nodeType at q/node.qon:340 (%s)\n", caller);
...
if (globalTrace)
    printf("nodeTypes at q/node.qon:344 (%s)\n", caller);
...
if (globalTrace)
    snprintf(caller, 1024, "from q/node.qon:350");
    if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);
...
if (globalTrace)
    printf("nodeCompile at q/node.qon:352 (%s)\n", caller);
...
if (globalTrace)
    snprintf(caller, 1024, "from q/node.qon:379");
  if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);
...
//Building function test4 from line: 45

void test4() {
  char* message = "fail";

if (globalTrace)
    printf("test4 at q/tests.qon:45 (%s)\n", caller);

if (globalTrace)
    snprintf(caller, 1024, "from q/tests.qon:46");
  if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);
...
//Building function test5 from line: 48

void test5() {
  char* message = "fail";

if (globalTrace)
    printf("test5 at q/tests.qon:48 (%s)\n", caller);
...
if (globalTrace)
    snprintf(caller, 1024, "from q/tests.qon:51");
  if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);
...
//Building function test6 from line: 53

void test6() {
  
if (globalTrace)
    printf("test6 at q/tests.qon:53 (%s)\n", caller);
...
if (globalTrace)
  ...
  if ( true) {
if (globalTrace)
    snprintf(caller, 1024, "from q/tests.qon:58");
    if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);
...
if (globalTrace)
    snprintf(caller, 1024, "from q/tests.qon:59");
    if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);
...
//Building function test7_do from line: 61

int test7_do(int count) {
  
if (globalTrace)
    printf("test7_do at q/tests.qon:61 (%s)\n", caller);
...
if (globalTrace)
    snprintf(caller, 1024, "from q/tests.qon:66");
  if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);
...
if (globalTrace)
    snprintf(caller, 1024, "from q/tests.qon:67");
  if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);
...
//Building function test7 from line: 69

void test7() {
  
if (globalTrace)
    printf("test7 at q/tests.qon:69 (%s)\n", caller);
...
if (globalTrace)
    snprintf(caller, 1024, "from q/tests.qon:74");
    if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);
...
if (globalTrace)
    snprintf(caller, 1024, "from q/tests.qon:75");
    if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);
...
//Building function beer from line: 77

void beer() {
  
if (globalTrace)
    printf("beer at q/tests.qon:77 (%s)\n", caller);
...
//Building function plural from line: 86

char* plural(int num) {
  
if (globalTrace)
    printf("plural at q/tests.qon:86 (%s)\n", caller);

if (globalTrace)
    snprintf(caller, 1024, "from q/tests.qon:89");
  if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);
...
//Building function beers from line: 91

int beers(int count) {
  int newcount = 0;

if (globalTrace)
    printf("beers at q/tests.qon:91 (%s)\n", caller);
...
if (globalTrace)
    snprintf(caller, 1024, "from q/tests.qon:96");
  if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);
...
if (globalTrace)
    snprintf(caller, 1024, "from q/tests.qon:104");
  if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);
...
if (globalTrace)
    snprintf(caller, 1024, "from q/tests.qon:105");
  if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);
...
//Building function test8 from line: 107

void test8() {
  
if (globalTrace)
    printf("test8 at q/tests.qon:107 (%s)\n", caller);
...
if (globalTrace)
    snprintf(caller, 1024, "from q/tests.qon:112");
    if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);
...
if (globalTrace)
    snprintf(caller, 1024, "from q/tests.qon:113");
    if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);
...
//Building function test9 from line: 115

void test9() {
  int answer = -999999;

if (globalTrace)
    printf("test9 at q/tests.qon:115 (%s)\n", caller);
...
if (globalTrace)
    snprintf(caller, 1024, "from q/tests.qon:168");
    if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);
...
//Building function test10 from line: 173

void test10() {
  char* testString = "This is a test string";

if (globalTrace)
    printf("test10 at q/tests.qon:173 (%s)\n", caller);
...
//Building function test12 from line: 183

void test12() {
  box b = NULL;

if (globalTrace)
    printf("test12 at q/tests.qon:183 (%s)\n", caller);
...
if (globalTrace)
    snprintf(caller, 1024, "from q/tests.qon:188");
  if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);

  b->str = "12. pass structure accessors\n";

if (globalTrace)
    snprintf(caller, 1024, "from q/tests.qon:189");
  if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);
...
//Building function test13 from line: 191
...
if (globalTrace)
    printf("test13 at q/tests.qon:191 (%s)\n", caller);
...
if (globalTrace)
    snprintf(caller, 1024, "from q/tests.qon:202");
    if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);
...
//Building function test15 from line: 207
...
if (globalTrace)
    printf("test15 at q/tests.qon:207 (%s)\n", caller);
...
if (globalTrace)
    snprintf(caller, 1024, "from q/tests.qon:212");
    if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);
...
//Building function test16 from line: 215
...
if (globalTrace)
    printf("test16 at q/tests.qon:215 (%s)\n", caller);
...
//Building function test17 from line: 239

void test17() {
  list l = NULL;

if (globalTrace)
    printf("test17 at q/tests.qon:239 (%s)\n", caller);
...
//Building function test18 from line: 250
...
if (globalTrace)
    printf("test18 at q/tests.qon:250 (%s)\n", caller);
...
//Building function test19 from line: 264
...
if (globalTrace)
    printf("test19 at q/tests.qon:264 (%s)\n", caller);
...
if (globalTrace)
    snprintf(caller, 1024, "from q/tests.qon:277");
    if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);
...
//Building function concatenateLists from line: 282

list concatenateLists(list oldL, list newL) {
  
if (globalTrace)
    printf("concatenateLists at q/tests.qon:282 (%s)\n", caller);

if (globalTrace)
    snprintf(caller, 1024, "from q/tests.qon:284");
  if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);
...
//Building function test20 from line: 287
...
if (globalTrace)
    printf("test20 at q/tests.qon:287 (%s)\n", caller);
...
if (globalTrace)
    snprintf(caller, 1024, "from q/tests.qon:302");
    if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);
...
if (globalTrace)
    snprintf(caller, 1024, "from q/tests.qon:303");
    if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);
...
//Building function test21 from line: 307
...
if (globalTrace)
    printf("test21 at q/tests.qon:307 (%s)\n", caller);
...
//Building function test22 from line: 323
...
if (globalTrace)
    printf("test22 at q/tests.qon:323 (%s)\n", caller);
...
if (globalTrace)
    snprintf(caller, 1024, "from q/tests.qon:340");
    if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);

    printf("\nOut: ");

if (globalTrace)
    snprintf(caller, 1024, "from q/tests.qon:341");
    if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);

    displayList(out, 0, true);

if (globalTrace)
    snprintf(caller, 1024, "from q/tests.qon:342");
    if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);
...
//Building function test23 from line: 346
...
if (globalTrace)
    printf("test23 at q/tests.qon:346 (%s)\n", caller);
...
if (globalTrace)
    snprintf(caller, 1024, "from q/tests.qon:362");
    if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);

    displayList(original, 0, true);

if (globalTrace)
    snprintf(caller, 1024, "from q/tests.qon:363");
    if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);

    printf("\nOut: ");

if (globalTrace)
    snprintf(caller, 1024, "from q/tests.qon:364");
    if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);
...
if (globalTrace)
    snprintf(caller, 1024, "from q/ansi3.qon:42");
      if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);
...
if (globalTrace)
    snprintf(caller, 1024, "from q/ansi3.qon:60");
        if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);

        if ( equalBox(boxSymbol("new"), thing)) {
if (globalTrace)
    snprintf(caller, 1024, "from q/ansi3.qon:64");
          if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);
...
if (globalTrace)
    snprintf(caller, 1024, "from q/ansi3.qon:68");
          if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);
...
if (globalTrace)
    snprintf(caller, 1024, "from q/ansi3.qon:76");
            if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);
...
if (globalTrace)
    snprintf(caller, 1024, "from q/ansi3.qon:85");
              if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);
...
if (globalTrace)
    snprintf(caller, 1024, "from q/ansi3.qon:91");
              if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);
...
if (globalTrace)
    printf("ansi3RecurList at q/ansi3.qon:108 (%s)\n", caller);

if (globalTrace)
    snprintf(caller, 1024, "from q/ansi3.qon:112");
  if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);

  if ( isEmpty(expr)) {
if (globalTrace)
    snprintf(caller, 1024, "from q/ansi3.qon:113");
    if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);
...
if (globalTrace)
    snprintf(caller, 1024, "from q/ansi3.qon:115");
    if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);

    ansi3Expression(car(expr), indent);

if (globalTrace)
    snprintf(caller, 1024, "from q/ansi3.qon:116");
    if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);
...
if (globalTrace)
    printf("ansi3If at q/ansi3.qon:125 (%s)\n", caller);
...
if (globalTrace)
    snprintf(caller, 1024, "from q/ansi3.qon:129");
  if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);
...
if (globalTrace)
    snprintf(caller, 1024, "from q/ansi3.qon:133");
  if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);

  ansi3displays("} else {");

if (globalTrace)
    snprintf(caller, 1024, "from q/ansi3.qon:134");
  if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);
...
if (globalTrace)
    printf("ansi3SetStruct at q/ansi3.qon:138 (%s)\n", caller);
...
if (globalTrace)
    snprintf(caller, 1024, "from q/ansi3.qon:145");
  if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);
...
if (globalTrace)
    printf("ansi3GetStruct at q/ansi3.qon:147 (%s)\n", caller);
...
if (globalTrace)
    printf("ansi3Set at q/ansi3.qon:155 (%s)\n", caller);
...
if (globalTrace)
    printf("ansi3Return at q/ansi3.qon:162 (%s)\n", caller);
...
if (globalTrace)
    printf("ansi3Statement at q/ansi3.qon:173 (%s)\n", caller);
...
if (globalTrace)
    snprintf(caller, 1024, "from q/ansi3.qon:181");
      if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);

      if ( equalBox(boxString("if"), first(node))) {
if (globalTrace)
    snprintf(caller, 1024, "from q/ansi3.qon:182");
        if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);
...
if (globalTrace)
    snprintf(caller, 1024, "from q/ansi3.qon:210");
      if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);
...
if (globalTrace)
    printf("ansi3Declarations at q/ansi3.qon:216 (%s)\n", caller);
...
if (globalTrace)
    printf("ansi3Function at q/ansi3.qon:230 (%s)\n", caller);
...
if (globalTrace)
    snprintf(caller, 1024, "from q/ansi3.qon:245");
    if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);
...
//Building function ansi3ForwardDeclaration from line: 267

void ansi3ForwardDeclaration(list node) {
  
if (globalTrace)
    printf("ansi3ForwardDeclaration at q/ansi3.qon:267 (%s)\n", caller);
...
if (globalTrace)
    snprintf(caller, 1024, "from q/ansi3.qon:270");
    if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);
...
//Building function ansi3ForwardDeclarations from line: 277

void ansi3ForwardDeclarations(list tree) {
  
if (globalTrace)
    printf("ansi3ForwardDeclarations at q/ansi3.qon:277 (%s)\n", caller);
...
//Building function ansi3Functions from line: 283

void ansi3Functions(list tree) {
  
if (globalTrace)
    printf("ansi3Functions at q/ansi3.qon:283 (%s)\n", caller);
...
//Building function ansi3Includes from line: 289

void ansi3Includes(list nodes) {
  
if (globalTrace)
    printf("ansi3Includes at q/ansi3.qon:289 (%s)\n", caller);
...
//Building function ansi3TypeDecl from line: 297

void ansi3TypeDecl(list l) {
  
if (globalTrace)
    printf("ansi3TypeDecl at q/ansi3.qon:297 (%s)\n", caller);
...
if (globalTrace)
  ...
  if ( greaterthan(listLength(l), 2)) {
if (globalTrace)
    snprintf(caller, 1024, "from q/ansi3.qon:301");
    if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);
...
//Building function ansi3StructComponents from line: 314

void ansi3StructComponents(list node) {
  
if (globalTrace)
    printf("ansi3StructComponents at q/ansi3.qon:314 (%s)\n", caller);
...
//Building function ansi3Struct from line: 320

void ansi3Struct(list node) {
  
if (globalTrace)
    printf("ansi3Struct at q/ansi3.qon:320 (%s)\n", caller);
...
//Building function ansi3TypeMap from line: 323

box ansi3TypeMap(box aSym) {
  list symMap = NULL;

if (globalTrace)
    printf("ansi3TypeMap at q/ansi3.qon:323 (%s)\n", caller);
...
if (globalTrace)
  ...
  if ( truthy(assoc(stringify(aSym), symMap))) {
if (globalTrace)
    snprintf(caller, 1024, "from q/ansi3.qon:330");
    if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);
...
//Building function ansi3FuncMap from line: 333

box ansi3FuncMap(box aSym) {
  list symMap = NULL;

if (globalTrace)
    printf("ansi3FuncMap at q/ansi3.qon:333 (%s)\n", caller);
...
if (globalTrace)
    ...
    if ( truthy(assoc(stringify(aSym), symMap))) {
if (globalTrace)
    snprintf(caller, 1024, "from q/ansi3.qon:360");
      if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);
...
if (globalTrace)
    snprintf(caller, 1024, "from q/ansi3.qon:361");
      if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);
...
if (globalTrace)
    snprintf(caller, 1024, "from q/ansi3.qon:362");
    if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);
...
//Building function ansi3Type from line: 364

void ansi3Type(list node) {
  
if (globalTrace)
    printf("ansi3Type at q/ansi3.qon:364 (%s)\n", caller);
...
if (globalTrace)
    snprintf(caller, 1024, "from q/ansi3.qon:371");
    if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);
...
//Building function ansi3Types from line: 374

void ansi3Types(list nodes) {
  
if (globalTrace)
    printf("ansi3Types at q/ansi3.qon:374 (%s)\n", caller);
...
//Building function ansi3Compile from line: 384
...
if (globalTrace)
    printf("ansi3Compile at q/ansi3.qon:384 (%s)\n", caller);
...
if (globalTrace)
    snprintf(caller, 1024, "from q/ansi3.qon:391");
  if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);
...
if (globalTrace)
    snprintf(caller, 1024, "from q/ansi3.qon:400");
  if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);
...
if (globalTrace)
    snprintf(caller, 1024, "from q/ansi2.qon:51");
      if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);
...
if (globalTrace)
    snprintf(caller, 1024, "from q/ansi2.qon:68");
          if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);
...
if (globalTrace)
    snprintf(caller, 1024, "from q/ansi2.qon:76");
            if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);
...
if (globalTrace)
    printf("ansi2RecurList at q/ansi2.qon:108 (%s)\n", caller);

if (globalTrace)
    snprintf(caller, 1024, "from q/ansi2.qon:112");
  if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);

  if ( isEmpty(expr)) {
if (globalTrace)
    snprintf(caller, 1024, "from q/ansi2.qon:113");
    if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);
...
if (globalTrace)
    snprintf(caller, 1024, "from q/ansi2.qon:115");
    if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);
...
if (globalTrace)
    printf("ansi2If at q/ansi2.qon:125 (%s)\n", caller);
...
if (globalTrace)
    snprintf(caller, 1024, "from q/ansi2.qon:133");
  if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);
...
if (globalTrace)
    printf("ansi2SetStruct at q/ansi2.qon:138 (%s)\n", caller);
...
if (globalTrace)
    snprintf(caller, 1024, "from q/ansi2.qon:141");
  if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);

  printf("%s->%s = ", stringify(second(node)), stringify(third(node)));

if (globalTrace)
    snprintf(caller, 1024, "from q/ansi2.qon:145");
  if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);
...
if (globalTrace)
    printf("ansi2GetStruct at q/ansi2.qon:147 (%s)\n", caller);
...
if (globalTrace)
    printf("ansi2Set at q/ansi2.qon:155 (%s)\n", caller);
...
if (globalTrace)
    printf("ansi2Return at q/ansi2.qon:162 (%s)\n", caller);
...
if (globalTrace)
    printf("ansi2Statement at q/ansi2.qon:173 (%s)\n", caller);
...
if (globalTrace)
    snprintf(caller, 1024, "from q/ansi2.qon:184");
        ...
        if ( equalBox(boxString("return"), first(node))) {
if (globalTrace)
    snprintf(caller, 1024, "from q/ansi2.qon:185");
          if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);
...
if (globalTrace)
    printf("ansi2Body at q/ansi2.qon:191 (%s)\n", caller);
...
if (globalTrace)
    snprintf(caller, 1024, "from q/ansi2.qon:203");
    if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);
...
if (globalTrace)
    printf("ansi2Declarations at q/ansi2.qon:209 (%s)\n", caller);
...
if (globalTrace)
  ...
  if ( isEmpty(decls)) {
if (globalTrace)
    snprintf(caller, 1024, "from q/ansi2.qon:212");
    if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);
...
if (globalTrace)
    snprintf(caller, 1024, "from q/ansi2.qon:214");
    if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);
...
if (globalTrace)
    printf("ansi2Function at q/ansi2.qon:223 (%s)\n", caller);
...
if (globalTrace)
    snprintf(caller, 1024, "from q/ansi2.qon:236");
    if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);
...
if (globalTrace)
    snprintf(caller, 1024, "from q/ansi2.qon:239");
    if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);
...
if (globalTrace)
    snprintf(caller, 1024, "from q/ansi2.qon:243");
      if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);
...
if (globalTrace)
    snprintf(caller, 1024, "from q/ansi2.qon:253");
    if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);
...
if (globalTrace)
    snprintf(caller, 1024, "from q/ansi2.qon:258");
    if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);
...
if (globalTrace)
    printf("ansi2ForwardDeclaration at q/ansi2.qon:260 (%s)\n", caller);
...
if (globalTrace)
    snprintf(caller, 1024, "from q/ansi2.qon:263");
    if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);
...
if (globalTrace)
    printf("ansi2ForwardDeclarations at q/ansi2.qon:270 (%s)\n", caller);
...
if (globalTrace)
    snprintf(caller, 1024, "from q/ansi2.qon:273");
    if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);
...
if (globalTrace)
    printf("ansi2Functions at q/ansi2.qon:276 (%s)\n", caller);
...
if (globalTrace)
    printf("ansi2Includes at q/ansi2.qon:282 (%s)\n", caller);
...
if (globalTrace)
    snprintf(caller, 1024, "from q/ansi2.qon:288");
  if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);
...
//Building function ansi2TypeDecl from line: 291

void ansi2TypeDecl(list l) {
  
if (globalTrace)
    printf("ansi2TypeDecl at q/ansi2.qon:291 (%s)\n", caller);

if (globalTrace)
    snprintf(caller, 1024, "from q/ansi2.qon:293");
  if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);

  if ( greaterthan(listLength(l), 2)) {
if (globalTrace)
    snprintf(caller, 1024, "from q/ansi2.qon:295");
    if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);

    printIndent(1);

if (globalTrace)
    snprintf(caller, 1024, "from q/ansi2.qon:296");
    if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);
...
if (globalTrace)
    snprintf(caller, 1024, "from q/ansi2.qon:302");
    if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);
...
//Building function ansi2StructComponents from line: 308

void ansi2StructComponents(list node) {
  
if (globalTrace)
    printf("ansi2StructComponents at q/ansi2.qon:308 (%s)\n", caller);
...
if (globalTrace)
  ...
  if ( isEmpty(node)) {
if (globalTrace)
    snprintf(caller, 1024, "from q/ansi2.qon:311");
    if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);
...
if (globalTrace)
    snprintf(caller, 1024, "from q/ansi2.qon:312");
    if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);
...
//Building function ansi2Struct from line: 314

void ansi2Struct(list node) {
  
if (globalTrace)
    printf("ansi2Struct at q/ansi2.qon:314 (%s)\n", caller);
...
//Building function ansi2TypeMap from line: 317

box ansi2TypeMap(box aSym) {
  list symMap = NULL;

if (globalTrace)
    printf("ansi2TypeMap at q/ansi2.qon:317 (%s)\n", caller);
...
if (globalTrace)
    snprintf(caller, 1024, "from q/ansi2.qon:325");
  if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);
...
if (globalTrace)
    snprintf(caller, 1024, "from q/ansi2.qon:327");
    if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);
...
//Building function ansi2FuncMap from line: 329

box ansi2FuncMap(box aSym) {
  list symMap = NULL;

if (globalTrace)
    printf("ansi2FuncMap at q/ansi2.qon:329 (%s)\n", caller);

if (globalTrace)
    snprintf(caller, 1024, "from q/ansi2.qon:331");
  if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);

  if ( equalString("symbol", boxType(aSym))) {
if (globalTrace)
    snprintf(caller, 1024, "from q/ansi2.qon:333");
    if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);
...
if (globalTrace)
    ...
    if ( truthy(assoc(stringify(aSym), symMap))) {
if (globalTrace)
    snprintf(caller, 1024, "from q/ansi2.qon:356");
      if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);
...
//Building function ansi2Type from line: 360

void ansi2Type(list node) {
  
if (globalTrace)
    printf("ansi2Type at q/ansi2.qon:360 (%s)\n", caller);
...
//Building function ansi2Types from line: 370

void ansi2Types(list nodes) {
  
if (globalTrace)
    printf("ansi2Types at q/ansi2.qon:370 (%s)\n", caller);

if (globalTrace)
    snprintf(caller, 1024, "from q/ansi2.qon:372");
  if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);
...
//Building function ansi2Compile from line: 380
...
if (globalTrace)
    printf("ansi2Compile at q/ansi2.qon:380 (%s)\n", caller);
...
if (globalTrace)
    snprintf(caller, 1024, "from q/ansi2.qon:392");
  if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);
...
if (globalTrace)
    snprintf(caller, 1024, "from q/ansi2.qon:399");
  if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);

  ansi2Includes(cdr(first(tree)));

if (globalTrace)
    snprintf(caller, 1024, "from q/ansi2.qon:400");
  if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);

  ansi2Types(cdr(second(tree)));

if (globalTrace)
    snprintf(caller, 1024, "from q/ansi2.qon:403");
  if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);

  ansi2displays("Box* globalStackTrace = NULL;\n");

if (globalTrace)
    snprintf(caller, 1024, "from q/ansi2.qon:404");
  if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);

  ansi2displays("\nbool isNil(list p) {\n    return p == NULL;\n}\n\n\n//Forward declarations\n");

if (globalTrace)
    snprintf(caller, 1024, "from q/ansi2.qon:406");
  if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);

  ansi2ForwardDeclarations(cdr(third(tree)));

if (globalTrace)
    snprintf(caller, 1024, "from q/ansi2.qon:407");
  if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);

  ansi2displays("\n\n//End forward declarations\n\n");

if (globalTrace)
    snprintf(caller, 1024, "from q/ansi2.qon:408");
  if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);

  ansi2Functions(cdr(third(tree)));

if (globalTrace)
    snprintf(caller, 1024, "from q/ansi2.qon:409");
  if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);
...
if (globalTrace)
    snprintf(caller, 1024, "from q/ansi.qon:143");
    if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);
...
if (globalTrace)
    snprintf(caller, 1024, "from q/ansi.qon:155");
    if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);
...
if (globalTrace)
    printf("ansiDeclarations at q/ansi.qon:157 (%s)\n", caller);
...
if (globalTrace)
    snprintf(caller, 1024, "from q/ansi.qon:163");
    if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);
...
if (globalTrace)
    snprintf(caller, 1024, "from q/ansi.qon:169");
    if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);
...
if (globalTrace)
    printf("ansiFunction at q/ansi.qon:171 (%s)\n", caller);
...
if (globalTrace)
    snprintf(caller, 1024, "from q/ansi.qon:180");
    if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);
...
if (globalTrace)
    ...
    if ( inList(toStr(name), noStackTrace())) {
if (globalTrace)
    snprintf(caller, 1024, "from q/ansi.qon:193");
      if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);
...
if (globalTrace)
    snprintf(caller, 1024, "from q/ansi.qon:199");
    if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);
...
if (globalTrace)
    snprintf(caller, 1024, "from q/ansi.qon:204");
    if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);
...
if (globalTrace)
    printf("ansiForwardDeclaration at q/ansi.qon:206 (%s)\n", caller);

if (globalTrace)
    snprintf(caller, 1024, "from q/ansi.qon:208");
  if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);
...
if (globalTrace)
    snprintf(caller, 1024, "from q/ansi.qon:215");
    if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);

    ansiFunctionArgs(cdr(assoc("intype", cdr(node))));

if (globalTrace)
    snprintf(caller, 1024, "from q/ansi.qon:216");
    if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);
...
if (globalTrace)
    printf("ansiForwardDeclarations at q/ansi.qon:218 (%s)\n", caller);
...
if (globalTrace)
    snprintf(caller, 1024, "from q/ansi.qon:223");
    if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);

    ansiForwardDeclaration(car(tree));

if (globalTrace)
    snprintf(caller, 1024, "from q/ansi.qon:224");
    if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);
...
if (globalTrace)
    printf("ansiFunctions at q/ansi.qon:226 (%s)\n", caller);
...
if (globalTrace)
    snprintf(caller, 1024, "from q/ansi.qon:230");
    if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);
...
if (globalTrace)
    printf("ansiIncludes at q/ansi.qon:231 (%s)\n", caller);

if (globalTrace)
    snprintf(caller, 1024, "from q/ansi.qon:233");
  if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);
...
if (globalTrace)
    snprintf(caller, 1024, "from q/ansi.qon:237");
  if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);

  printf("%s", "void qlog(const char* format, ...) { va_list args; va_start (args, format); vfprintf (stderr, format, args); va_end (args); }");

if (globalTrace)
    snprintf(caller, 1024, "from q/ansi.qon:238");
  if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);
...
//Building function ansiTypeDecl from line: 241

void ansiTypeDecl(list l) {
  
if (globalTrace)
    printf("ansiTypeDecl at q/ansi.qon:241 (%s)\n", caller);
...
if (globalTrace)
  ...
  if ( greaterthan(listLength(l), 2)) {
if (globalTrace)
    snprintf(caller, 1024, "from q/ansi.qon:245");
    if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);
...
if (globalTrace)
    snprintf(caller, 1024, "from q/ansi.qon:252");
    if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);

    printIndent(1);

if (globalTrace)
    snprintf(caller, 1024, "from q/ansi.qon:253");
    if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);
...
//Building function ansiStructComponents from line: 258

void ansiStructComponents(list node) {
  
if (globalTrace)
    printf("ansiStructComponents at q/ansi.qon:258 (%s)\n", caller);
...
//Building function ansiStruct from line: 264

void ansiStruct(list node) {
  
if (globalTrace)
    printf("ansiStruct at q/ansi.qon:264 (%s)\n", caller);

if (globalTrace)
    snprintf(caller, 1024, "from q/ansi.qon:265");
  if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);
...
//Building function ansiTypeMap from line: 267

box ansiTypeMap(box aSym) {
  list symMap = NULL;

if (globalTrace)
    printf("ansiTypeMap at q/ansi.qon:267 (%s)\n", caller);

if (globalTrace)
    snprintf(caller, 1024, "from q/ansi.qon:269");
  if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);
...
if (globalTrace)
  ...
  if ( truthy(assoc(stringify(aSym), symMap))) {
if (globalTrace)
    snprintf(caller, 1024, "from q/ansi.qon:276");
    if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);
...
if (globalTrace)
    snprintf(caller, 1024, "from q/ansi.qon:277");
    if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);
...
//Building function ansiFuncMap from line: 279

box ansiFuncMap(box aSym) {
  list symMap = NULL;

if (globalTrace)
    printf("ansiFuncMap at q/ansi.qon:279 (%s)\n", caller);
...
if (globalTrace)
  ...
  if ( equalString("symbol", boxType(aSym))) {
if (globalTrace)
    snprintf(caller, 1024, "from q/ansi.qon:283");
    if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);
...
if (globalTrace)
    snprintf(caller, 1024, "from q/ansi.qon:307");
      if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);
...
//Building function ansiType from line: 310

void ansiType(list node) {
  
if (globalTrace)
    printf("ansiType at q/ansi.qon:310 (%s)\n", caller);
...
if (globalTrace)
    snprintf(caller, 1024, "from q/ansi.qon:316");
    if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);
...
if (globalTrace)
    snprintf(caller, 1024, "from q/ansi.qon:317");
    if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);
...
//Building function ansiTypes from line: 320

void ansiTypes(list nodes) {
  
if (globalTrace)
    printf("ansiTypes at q/ansi.qon:320 (%s)\n", caller);
...
if (globalTrace)
  ...
  if ( isEmpty(nodes)) {
if (globalTrace)
    snprintf(caller, 1024, "from q/ansi.qon:323");
    if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);
...
if (globalTrace)
    snprintf(caller, 1024, "from q/ansi.qon:324");
    if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);
...
//Building function ansiCompile from line: 330
...
if (globalTrace)
    printf("ansiCompile at q/ansi.qon:330 (%s)\n", caller);
...
if (globalTrace)
    snprintf(caller, 1024, "from q/perl.qon:301");
  if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);

  printf("sub character { return chr(%s_[0])}\n", dollar());

if (globalTrace)
    snprintf(caller, 1024, "from q/perl.qon:302");
  if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);
...
//Building function perlTypeDecl from line: 306

void perlTypeDecl(list l) {
  
if (globalTrace)
    printf("perlTypeDecl at q/perl.qon:306 (%s)\n", caller);
...
if (globalTrace)
    printf("perlStructComponents at q/perl.qon:311 (%s)\n", caller);
...
if (globalTrace)
    printf("perlStruct at q/perl.qon:317 (%s)\n", caller);
...
if (globalTrace)
    printf("perlTypeMap at q/perl.qon:320 (%s)\n", caller);
...
//Building function perlConstMap from line: 332

box perlConstMap(box aSym) {
  list symMap = NULL;

if (globalTrace)
    printf("perlConstMap at q/perl.qon:332 (%s)\n", caller);
...
//Building function perlFuncMap from line: 342

box perlFuncMap(box aSym) {
  list symMap = NULL;

if (globalTrace)
    printf("perlFuncMap at q/perl.qon:342 (%s)\n", caller);

if (globalTrace)
    snprintf(caller, 1024, "from q/perl.qon:344");
  if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);

  if ( equalString("symbol", boxType(aSym))) {
if (globalTrace)
    snprintf(caller, 1024, "from q/perl.qon:346");
    if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);
...
//Building function perlType from line: 359

void perlType(list node) {
  
if (globalTrace)
    printf("perlType at q/perl.qon:359 (%s)\n", caller);
...
//Building function perlTypes from line: 364

void perlTypes(list nodes) {
  
if (globalTrace)
    printf("perlTypes at q/perl.qon:364 (%s)\n", caller);
...
//Building function perlFunctionArgs from line: 370

void perlFunctionArgs(list tree) {
  
if (globalTrace)
    printf("perlFunctionArgs at q/perl.qon:370 (%s)\n", caller);
...
//Building function perlCompile from line: 380
...
if (globalTrace)
    printf("perlCompile at q/perl.qon:380 (%s)\n", caller);
...
if (globalTrace)
    snprintf(caller, 1024, "from q/perl.qon:416");
  if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);

  printf("%s%s%s%s", dollar(), "globalArgsCount = scalar(", atSym(), "ARGV)+1;\n");

if (globalTrace)
    snprintf(caller, 1024, "from q/perl.qon:417");
  if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);
...
if (globalTrace)
    printf("caar at q/lists.qon:48 (%s)\n", caller);
...
if (globalTrace)
    printf("cadr at q/lists.qon:49 (%s)\n", caller);
...
if (globalTrace)
    printf("caddr at q/lists.qon:50 (%s)\n", caller);
...
if (globalTrace)
    printf("cadddr at q/lists.qon:51 (%s)\n", caller);
...
if (globalTrace)
    printf("caddddr at q/lists.qon:52 (%s)\n", caller);
...
if (globalTrace)
    printf("cddr at q/lists.qon:53 (%s)\n", caller);
...
if (globalTrace)
    printf("first at q/lists.qon:54 (%s)\n", caller);
...
if (globalTrace)
    printf("second at q/lists.qon:55 (%s)\n", caller);
...
if (globalTrace)
    printf("third at q/lists.qon:56 (%s)\n", caller);
...
if (globalTrace)
    printf("fourth at q/lists.qon:57 (%s)\n", caller);
...
if (globalTrace)
    printf("fifth at q/lists.qon:58 (%s)\n", caller);
...
if (globalTrace)
    printf("isList at q/lists.qon:61 (%s)\n", caller);
...
if (globalTrace)
    snprintf(caller, 1024, "from q/lists.qon:66");
    if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);
...
if (globalTrace)
    printf("emptyList at q/lists.qon:68 (%s)\n", caller);

if (globalTrace)
    snprintf(caller, 1024, "from q/lists.qon:68");
  if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);
...
if (globalTrace)
    printf("isEmpty at q/lists.qon:70 (%s)\n", caller);
...
if (globalTrace)
    snprintf(caller, 1024, "from q/lists.qon:75");
    if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);
...
if (globalTrace)
    printf("listLength at q/lists.qon:77 (%s)\n", caller);
...
if (globalTrace)
    snprintf(caller, 1024, "from q/lists.qon:83");
    if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);
...
if (globalTrace)
    printf("alistCons at q/lists.qon:86 (%s)\n", caller);
...
if (globalTrace)
    printf("assoc at q/lists.qon:89 (%s)\n", caller);
...
if (globalTrace)
    snprintf(caller, 1024, "from q/lists.qon:97");
    if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);
...
if (globalTrace)
    printf("chooseBox at q/lists.qon:110 (%s)\n", caller);
...
if (globalTrace)
    printf("mlistLiteral at q/lists.qon:126 (%s)\n", caller);
...
if (globalTrace)
  ...
  if ( isNil(b)) {
if (globalTrace)
    snprintf(caller, 1024, "from q/lists.qon:129");
    if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);
...
if (globalTrace)
    snprintf(caller, 1024, "from q/lists.qon:131");
    if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);
...
if (globalTrace)
    snprintf(caller, 1024, "from q/lists.qon:139");
          if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);
...
if (globalTrace)
    snprintf(caller, 1024, "from q/lists.qon:141");
          if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);
...
if (globalTrace)
    printf("doMultiList at q/lists.qon:148 (%s)\n", caller);
...
if (globalTrace)
    snprintf(caller, 1024, "from q/lists.qon:158");
      if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);
...
if (globalTrace)
    snprintf(caller, 1024, "from q/lists.qon:168");
      if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);
...
if (globalTrace)
    printf("doStringList at q/lists.qon:171 (%s)\n", caller);
...
if (globalTrace)
    printf("doSymbolList at q/lists.qon:188 (%s)\n", caller);
...
if (globalTrace)
    printf("doBoxList at q/lists.qon:206 (%s)\n", caller);
...
if (globalTrace)
    printf("concatLists at q/lists.qon:226 (%s)\n", caller);

if (globalTrace)
    snprintf(caller, 1024, "from q/lists.qon:228");
  if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);
...
if (globalTrace)
    printf("alistKeys at q/lists.qon:232 (%s)\n", caller);
...
if (globalTrace)
    printf("displayList at q/lists.qon:238 (%s)\n", caller);
...
if (globalTrace)
    printf("listReverse at q/lists.qon:270 (%s)\n", caller);

if (globalTrace)
    snprintf(caller, 1024, "from q/lists.qon:272");
  if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);
...
if (globalTrace)
    printf("inList at q/lists.qon:276 (%s)\n", caller);
...
if (globalTrace)
    snprintf(caller, 1024, "from q/lists.qon:285");
      if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);
...
if (globalTrace)
    printf("equalList at q/lists.qon:287 (%s)\n", caller);
...
if (globalTrace)
  ...
  if ( isNil(a)) {
if (globalTrace)
    snprintf(caller, 1024, "from q/lists.qon:290");
    if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);
...
if (globalTrace)
  ...
  if ( isNil(b)) {
if (globalTrace)
    snprintf(caller, 1024, "from q/lists.qon:298");
    if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);
...
if (globalTrace)
    snprintf(caller, 1024, "from q/lists.qon:302");
      if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);
...
if (globalTrace)
    printf("reverseRec at q/lists.qon:310 (%s)\n", caller);
...
if (globalTrace)
    printf("reverseList at q/lists.qon:317 (%s)\n", caller);
...
if (globalTrace)
    snprintf(caller, 1024, "from q/macros.qon:12");
    if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);

    if ( isList(l)) {
if (globalTrace)
    snprintf(caller, 1024, "from q/macros.qon:23");
      if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);

      if ( equalString(stringConcatenate("box", "List"), stringify(car(l)))) {
if (globalTrace)
    snprintf(caller, 1024, "from q/macros.qon:27");
        if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);
...
if (globalTrace)
    snprintf(caller, 1024, "from q/macros.qon:52");
      if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);
...
if (globalTrace)
    snprintf(caller, 1024, "from q/macros.qon:54");
      if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);
...
if (globalTrace)
    printf("macrosingle at q/macros.qon:59 (%s)\n", caller);

if (globalTrace)
    snprintf(caller, 1024, "from q/macros.qon:60");
  if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);

  if ( isEmpty(l)) {
if (globalTrace)
    snprintf(caller, 1024, "from q/macros.qon:61");
    if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);
...
if (globalTrace)
    ...
    if ( isList(l)) {
if (globalTrace)
    snprintf(caller, 1024, "from q/macros.qon:68");
      if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);
...
if (globalTrace)
    snprintf(caller, 1024, "from q/macros.qon:80");
        if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);

        val->str = replace;

if (globalTrace)
    snprintf(caller, 1024, "from q/macros.qon:81");
        if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);
...
if (globalTrace)
    printf("macrolist at q/macros.qon:88 (%s)\n", caller);
...
if (globalTrace)
  ...
  if ( isEmpty(l)) {
if (globalTrace)
    snprintf(caller, 1024, "from q/macros.qon:90");
    if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);
...
if (globalTrace)
    ...
    if ( isList(l)) {
if (globalTrace)
    snprintf(caller, 1024, "from q/macros.qon:99");
      if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);
...
if (globalTrace)
    snprintf(caller, 1024, "from q/macros.qon:117");
      if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);
...
//Building function filterVoid from line: 11

list filterVoid(list l) {
  box token = NULL;

if (globalTrace)
    printf("filterVoid at q/compiler.qon:11 (%s)\n", caller);
...
if (globalTrace)
    snprintf(caller, 1024, "from q/compiler.qon:19");
    if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);

    if ( equalString("void", token->typ)) {
if (globalTrace)
    snprintf(caller, 1024, "from q/compiler.qon:20");
      if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);
...
if (globalTrace)
    snprintf(caller, 1024, "from q/compiler.qon:21");
      if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);
...
//Building function filterTokens from line: 23

list filterTokens(list l) {
  box token = NULL;

if (globalTrace)
    printf("filterTokens at q/compiler.qon:23 (%s)\n", caller);
...
if (globalTrace)
    snprintf(caller, 1024, "from q/compiler.qon:31");
    if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);

    if ( equalString(boxType(token), "symbol")) {
if (globalTrace)
    snprintf(caller, 1024, "from q/compiler.qon:33");
      if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);

      if ( equalString("__LINE__", stringify(token))) {
if (globalTrace)
    snprintf(caller, 1024, "from q/compiler.qon:35");
        if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);
...
if (globalTrace)
    snprintf(caller, 1024, "from q/compiler.qon:40");
        if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);

        if ( equalString("__COLUMN__", stringify(token))) {
if (globalTrace)
    snprintf(caller, 1024, "from q/compiler.qon:42");
          if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);
...
if (globalTrace)
    snprintf(caller, 1024, "from q/compiler.qon:47");
          if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);

          if ( equalString("__FILE__", stringify(token))) {
if (globalTrace)
    snprintf(caller, 1024, "from q/compiler.qon:49");
            if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);
...
if (globalTrace)
    snprintf(caller, 1024, "from q/compiler.qon:54");
            if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);
...
if (globalTrace)
    snprintf(caller, 1024, "from q/compiler.qon:55");
      if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);
...
//Building function finish_token from line: 57

box finish_token(char* prog, int start, int len, int line, int column, char* filename) {
  box token = NULL;

if (globalTrace)
    printf("finish_token at q/compiler.qon:57 (%s)\n", caller);
...
if (globalTrace)
    snprintf(caller, 1024, "from q/compiler.qon:61");
    if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);

    token = boxSymbol(sub_string(prog, start, len));

if (globalTrace)
    snprintf(caller, 1024, "from q/compiler.qon:62");
    if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);
...
if (globalTrace)
    snprintf(caller, 1024, "from q/compiler.qon:69");
    if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);
...
if (globalTrace)
    snprintf(caller, 1024, "from q/compiler.qon:70");
    if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);
...
//Building function readString from line: 72

char* readString(char* prog, int start, int len) {
  char* token = "";

if (globalTrace)
    printf("readString at q/compiler.qon:72 (%s)\n", caller);

if (globalTrace)
    snprintf(caller, 1024, "from q/compiler.qon:74");
  if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);
...
if (globalTrace)
    snprintf(caller, 1024, "from q/compiler.qon:78");
    if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);

    if ( equalString("\\", token)) {
if (globalTrace)
    snprintf(caller, 1024, "from q/compiler.qon:79");
      if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);
...
if (globalTrace)
    snprintf(caller, 1024, "from q/compiler.qon:80");
      if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);
...
//Building function readComment from line: 83

char* readComment(char* prog, int start, int len) {
  char* token = "";

if (globalTrace)
    printf("readComment at q/compiler.qon:83 (%s)\n", caller);
...
if (globalTrace)
    snprintf(caller, 1024, "from q/compiler.qon:143");
    if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);
...
if (globalTrace)
    snprintf(caller, 1024, "from q/compiler.qon:156");
        if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);

        if ( isWhiteSpace(stringify(token))) {
if (globalTrace)
    snprintf(caller, 1024, "from q/compiler.qon:158");
          if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);
...
if (globalTrace)
    snprintf(caller, 1024, "from q/compiler.qon:165");
            if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);
...
if (globalTrace)
    snprintf(caller, 1024, "from q/compiler.qon:173");
    if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);
...
//Building function isOpenBrace from line: 176

bool isOpenBrace(box b) {
  
if (globalTrace)
    printf("isOpenBrace at q/compiler.qon:176 (%s)\n", caller);
...
//Building function isCloseBrace from line: 185

bool isCloseBrace(box b) {
  
if (globalTrace)
    printf("isCloseBrace at q/compiler.qon:185 (%s)\n", caller);
...
if (globalTrace)
    snprintf(caller, 1024, "from q/compiler.qon:194");
      if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);
...
//Building function skipList from line: 198

list skipList(list l) {
  box b = NULL;

if (globalTrace)
    printf("skipList at q/compiler.qon:198 (%s)\n", caller);
...
if (globalTrace)
    snprintf(caller, 1024, "from q/compiler.qon:209");
        if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);
...
//Building function makeNode from line: 223

list makeNode(char* name, char* subname, list code, list children) {
  
if (globalTrace)
    printf("makeNode at q/compiler.qon:223 (%s)\n", caller);

if (globalTrace)
    snprintf(caller, 1024, "from q/compiler.qon:225");
  if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);
...
//Building function addToNode from line: 239

list addToNode(box key, box val, list node) {
  
if (globalTrace)
    printf("addToNode at q/compiler.qon:239 (%s)\n", caller);

if (globalTrace)
    snprintf(caller, 1024, "from q/compiler.qon:241");
  if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);
...
//Building function makeStatementNode from line: 244

list makeStatementNode(char* name, char* subname, list code, list children, box functionName) {
  
if (globalTrace)
    printf("makeStatementNode at q/compiler.qon:244 (%s)\n", caller);
...
//Building function astExpression from line: 249

list astExpression(list tree) {
  
if (globalTrace)
    printf("astExpression at q/compiler.qon:249 (%s)\n", caller);
...
//Building function astSubExpression from line: 257

list astSubExpression(list tree) {
  
if (globalTrace)
    printf("astSubExpression at q/compiler.qon:257 (%s)\n", caller);
...
//Building function astIf from line: 268

list astIf(list tree, box fname) {
  
if (globalTrace)
    printf("astIf at q/compiler.qon:268 (%s)\n", caller);
...
if (globalTrace)
    snprintf(caller, 1024, "from q/compiler.qon:279");
    if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);

    printf("Error at %s:%s!  If statement is missing the false branch.\n\n", stringify(getTag(car(first(tree)), boxString("filename"))), stringify(getTag(car(first(tree)), boxString("line"))));

if (globalTrace)
    snprintf(caller, 1024, "from q/compiler.qon:280");
    if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);
...
//Building function astSetStruct from line: 289

list astSetStruct(list tree) {
  
if (globalTrace)
    printf("astSetStruct at q/compiler.qon:289 (%s)\n", caller);

if (globalTrace)
    snprintf(caller, 1024, "from q/compiler.qon:291");
  if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);
...
//Building function astSet from line: 294

list astSet(list tree) {
  
if (globalTrace)
    printf("astSet at q/compiler.qon:294 (%s)\n", caller);
...
//Building function astGetStruct from line: 299

list astGetStruct(list tree) {
  
if (globalTrace)
    printf("astGetStruct at q/compiler.qon:299 (%s)\n", caller);
...
//Building function astReturnVoid from line: 302

list astReturnVoid(box fname) {
  
if (globalTrace)
    printf("astReturnVoid at q/compiler.qon:302 (%s)\n", caller);

if (globalTrace)
    snprintf(caller, 1024, "from q/compiler.qon:304");
  if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);
...
//Building function astStatement from line: 306

list astStatement(list tree, box fname) {
  
if (globalTrace)
    printf("astStatement at q/compiler.qon:306 (%s)\n", caller);
...
if (globalTrace)
    snprintf(caller, 1024, "from q/compiler.qon:319");
    if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);
...
if (globalTrace)
    snprintf(caller, 1024, "from q/compiler.qon:322");
      if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);
...
if (globalTrace)
    snprintf(caller, 1024, "from q/compiler.qon:327");
        if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);
...
if (globalTrace)
    snprintf(caller, 1024, "from q/compiler.qon:330");
          if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);
...
//Building function astBody from line: 344

list astBody(list tree, box fname) {
  
if (globalTrace)
    printf("astBody at q/compiler.qon:344 (%s)\n", caller);

if (globalTrace)
    snprintf(caller, 1024, "from q/compiler.qon:346");
  if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);
...
//Building function astFunction from line: 352
...
if (globalTrace)
    printf("astFunction at q/compiler.qon:352 (%s)\n", caller);
...
if (globalTrace)
    snprintf(caller, 1024, "from q/compiler.qon:361");
  if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);
...
if (globalTrace)
    snprintf(caller, 1024, "from q/compiler.qon:362");
  if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);
...
if (globalTrace)
    snprintf(caller, 1024, "from q/compiler.qon:363");
  if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);
...
if (globalTrace)
    snprintf(caller, 1024, "from q/compiler.qon:364");
  if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);
...
if (globalTrace)
    snprintf(caller, 1024, "from q/compiler.qon:365");
  if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);
...
if (globalTrace)
    snprintf(caller, 1024, "from q/compiler.qon:366");
  if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);
...
//Building function astFunctionList from line: 387

list astFunctionList(list tree) {
  
if (globalTrace)
    printf("astFunctionList at q/compiler.qon:387 (%s)\n", caller);
...
//Building function astFunctions from line: 395

list astFunctions(list tree) {
  
if (globalTrace)
    printf("astFunctions at q/compiler.qon:395 (%s)\n", caller);
...
//Building function loadLib from line: 403
...
if (globalTrace)
    printf("loadLib at q/compiler.qon:403 (%s)\n", caller);

if (globalTrace)
    snprintf(caller, 1024, "from q/compiler.qon:407");
  if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);
...
if (globalTrace)
    snprintf(caller, 1024, "from q/compiler.qon:409");
  if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);

  tree = macrowalk(tree);

if (globalTrace)
    snprintf(caller, 1024, "from q/compiler.qon:410");
  if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);
...
//Building function astInclude from line: 420

list astInclude(list tree) {
  
if (globalTrace)
    printf("astInclude at q/compiler.qon:420 (%s)\n", caller);
...
//Building function astIncludeList from line: 423

list astIncludeList(list tree) {
  
if (globalTrace)
    printf("astIncludeList at q/compiler.qon:423 (%s)\n", caller);
...
//Building function astIncludes from line: 430

list astIncludes(list tree) {
  
if (globalTrace)
    printf("astIncludes at q/compiler.qon:430 (%s)\n", caller);
...
//Building function astStruct from line: 439

list astStruct(list tree) {
  
if (globalTrace)
    printf("astStruct at q/compiler.qon:439 (%s)\n", caller);
...
//Building function astType from line: 442

list astType(list tree) {
  
if (globalTrace)
    printf("astType at q/compiler.qon:442 (%s)\n", caller);
...
//Building function astTypeList from line: 448

list astTypeList(list tree) {
  
if (globalTrace)
    printf("astTypeList at q/compiler.qon:448 (%s)\n", caller);
...
if (globalTrace)
  ...
  if ( isEmpty(tree)) {
if (globalTrace)
    snprintf(caller, 1024, "from q/compiler.qon:451");
    if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);
...
//Building function astTypes from line: 454

list astTypes(list tree) {
  
if (globalTrace)
    printf("astTypes at q/compiler.qon:454 (%s)\n", caller);
...
if (globalTrace)
    snprintf(caller, 1024, "from q/compiler.qon:458");
    if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);
...
if (globalTrace)
    snprintf(caller, 1024, "from q/compiler.qon:460");
    if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);

    if ( equalBox(boxString("types"), car(tree))) {
if (globalTrace)
    snprintf(caller, 1024, "from q/compiler.qon:461");
      if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);
...
//Building function declarationsof from line: 472

list declarationsof(list ass) {
  
if (globalTrace)
    printf("declarationsof at q/compiler.qon:472 (%s)\n", caller);

if (globalTrace)
    snprintf(caller, 1024, "from q/compiler.qon:473");
  if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);
...
//Building function codeof from line: 475

list codeof(list ass) {
  
if (globalTrace)
    printf("codeof at q/compiler.qon:475 (%s)\n", caller);
...
//Building function functionNameof from line: 478

list functionNameof(list ass) {
  
if (globalTrace)
    printf("functionNameof at q/compiler.qon:478 (%s)\n", caller);
...
//Building function nodeof from line: 481

list nodeof(list ass) {
  
if (globalTrace)
    printf("nodeof at q/compiler.qon:481 (%s)\n", caller);
...
if (globalTrace)
    snprintf(caller, 1024, "from q/compiler.qon:485");
    if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);

    printf("Given list does not contain nodes");

if (globalTrace)
    snprintf(caller, 1024, "from q/compiler.qon:486");
    if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);
...
//Building function lineof from line: 489

list lineof(list ass) {
  
if (globalTrace)
    printf("lineof at q/compiler.qon:489 (%s)\n", caller);

if (globalTrace)
    snprintf(caller, 1024, "from q/compiler.qon:491");
  if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);
...
//Building function subnameof from line: 494

list subnameof(list ass) {
  
if (globalTrace)
    printf("subnameof at q/compiler.qon:494 (%s)\n", caller);

if (globalTrace)
    snprintf(caller, 1024, "from q/compiler.qon:495");
  if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);
...
//Building function nameof from line: 497

list nameof(list ass) {
  
if (globalTrace)
    printf("nameof at q/compiler.qon:497 (%s)\n", caller);
...
//Building function childrenof from line: 500

list childrenof(list ass) {
  
if (globalTrace)
    printf("childrenof at q/compiler.qon:500 (%s)\n", caller);
...
//Building function isNode from line: 504

bool isNode(list val) {
  
if (globalTrace)
    printf("isNode at q/compiler.qon:504 (%s)\n", caller);
...
if (globalTrace)
  ...
  if ( isEmpty(val)) {
if (globalTrace)
    snprintf(caller, 1024, "from q/compiler.qon:509");
    if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);
...
if (globalTrace)
    snprintf(caller, 1024, "from q/compiler.qon:511");
    if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);
...
if (globalTrace)
    snprintf(caller, 1024, "from q/compiler.qon:515");
        if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);
...
//Building function isLeaf from line: 520

bool isLeaf(list n) {
  
if (globalTrace)
    printf("isLeaf at q/compiler.qon:520 (%s)\n", caller);

if (globalTrace)
    snprintf(caller, 1024, "from q/compiler.qon:521");
  if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);
...
//Building function noStackTrace from line: 523

list noStackTrace() {
  
if (globalTrace)
    printf("noStackTrace at q/compiler.qon:523 (%s)\n", caller);

if (globalTrace)
    snprintf(caller, 1024, "from q/compiler.qon:525");
  if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);
...
//Building function treeCompile from line: 555
...
if (globalTrace)
    printf("treeCompile at q/compiler.qon:555 (%s)\n", caller);
...
//Building function astBuild from line: 561
...
if (globalTrace)
    printf("astBuild at q/compiler.qon:561 (%s)\n", caller);
...
if (globalTrace)
    snprintf(caller, 1024, "from q/compiler.qon:565");
  if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);
...
//Building function astCompile from line: 578
...
if (globalTrace)
    printf("astCompile at q/compiler.qon:578 (%s)\n", caller);
...
if (globalTrace)
    snprintf(caller, 1024, "from q/compiler.qon:589");
  if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);
...
if (globalTrace)
    snprintf(caller, 1024, "from q/compiler.qon:591");
  if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);

  replace = cons(boxSymbol("fprintf"), cons(boxSymbol("stderr"), NULL));

if (globalTrace)
    snprintf(caller, 1024, "from q/compiler.qon:592");
  if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);
...
//Building function mergeIncludes from line: 604

list mergeIncludes(list program) {
  
if (globalTrace)
    printf("mergeIncludes at q/compiler.qon:604 (%s)\n", caller);
...
//Building function merge_recur from line: 611

list merge_recur(list incs, list program) {
  
if (globalTrace)
    printf("merge_recur at q/compiler.qon:611 (%s)\n", caller);

if (globalTrace)
    snprintf(caller, 1024, "from q/compiler.qon:613");
  if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);

  if ( greaterthan(listLength(incs), 0)) {
if (globalTrace)
    snprintf(caller, 1024, "from q/compiler.qon:615");
    if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);
...
if (globalTrace)
    snprintf(caller, 1024, "from q/compiler.qon:616");
    if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);
...
//Building function mergeInclude from line: 619
...
if (globalTrace)
    printf("mergeInclude at q/compiler.qon:619 (%s)\n", caller);
...
if (globalTrace)
  ...
  if ( isNil(inc)) {
if (globalTrace)
    snprintf(caller, 1024, "from q/compiler.qon:635");
    if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);
...
if (globalTrace)
    snprintf(caller, 1024, "from q/compiler.qon:649");
    if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);

    types = childrenof(cdr(assocPanic("types", inc, "Included file has no types section")));

if (globalTrace)
    snprintf(caller, 1024, "from q/compiler.qon:650");
    if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);
...
if (globalTrace)
    snprintf(caller, 1024, "from q/compiler.qon:652");
    if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);

    newtypes = concatLists(types, oldtypes);

if (globalTrace)
    snprintf(caller, 1024, "from q/compiler.qon:653");
    if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);

    newTypeNode = cons(boxSymbol("node"), alistCons(boxSymbol("children"), newtypes, cdr(oldtypesnode)));

if (globalTrace)
    snprintf(caller, 1024, "from q/compiler.qon:658");
    if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);
...
if (globalTrace)
    snprintf(caller, 1024, "from q/compiler.qon:670");
    if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);
...
//Building function equalBox from line: 58

bool equalBox(box a, box b) {
  
if (globalTrace)
    printf("equalBox at q/base.qon:58 (%s)\n", caller);
...
if (globalTrace)
    snprintf(caller, 1024, "from q/base.qon:64");
      if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);
...
if (globalTrace)
    snprintf(caller, 1024, "from q/base.qon:77");
            if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);
...
//Building function display from line: 79

void display(list l) {
  
if (globalTrace)
    printf("display at q/base.qon:79 (%s)\n", caller);
...
//Building function boxType from line: 97

char* boxType(box b) {
  
if (globalTrace)
    printf("boxType at q/base.qon:97 (%s)\n", caller);
...
//Building function makeBox from line: 100

box makeBox() {
  box b = NULL;

if (globalTrace)
    printf("makeBox at q/base.qon:100 (%s)\n", caller);
...
if (globalTrace)
    snprintf(caller, 1024, "from q/base.qon:110");
  if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);

  b->lis = NULL;

if (globalTrace)
    snprintf(caller, 1024, "from q/base.qon:111");
  if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);
...
//Building function makePair from line: 115

pair makePair() {
  
if (globalTrace)
    printf("makePair at q/base.qon:115 (%s)\n", caller);
...
//Building function boxString from line: 121

box boxString(char* s) {
  box b = NULL;

if (globalTrace)
    printf("boxString at q/base.qon:121 (%s)\n", caller);
...
if (globalTrace)
    snprintf(caller, 1024, "from q/base.qon:128");
  if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);

  b->typ = "string";

if (globalTrace)
    snprintf(caller, 1024, "from q/base.qon:129");
  if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);
...
//Building function boxSymbol from line: 131

box boxSymbol(char* s) {
  box b = NULL;

if (globalTrace)
    printf("boxSymbol at q/base.qon:131 (%s)\n", caller);
...
//Building function boxBool from line: 140

box boxBool(bool boo) {
  box b = NULL;

if (globalTrace)
    printf("boxBool at q/base.qon:140 (%s)\n", caller);
...
//Building function boxInt from line: 149

box boxInt(int val) {
  box b = NULL;

if (globalTrace)
    printf("boxInt at q/base.qon:149 (%s)\n", caller);
...
//Building function assertType from line: 158

void assertType(char* atype, box abox, int line, char* file) {
  
if (globalTrace)
    printf("assertType at q/base.qon:158 (%s)\n", caller);
...
//Building function unBoxString from line: 170

char* unBoxString(box b) {
  
if (globalTrace)
    printf("unBoxString at q/base.qon:170 (%s)\n", caller);
...
//Building function unBoxSymbol from line: 173

char* unBoxSymbol(box b) {
  
if (globalTrace)
    printf("unBoxSymbol at q/base.qon:173 (%s)\n", caller);
...
//Building function unBoxBool from line: 174

bool unBoxBool(box b) {
  
if (globalTrace)
    printf("unBoxBool at q/base.qon:174 (%s)\n", caller);
...
//Building function unBoxInt from line: 175

int unBoxInt(box b) {
  
if (globalTrace)
    printf("unBoxInt at q/base.qon:175 (%s)\n", caller);
...
//Building function stringify_rec from line: 177

char* stringify_rec(box b) {
  
if (globalTrace)
    printf("stringify_rec at q/base.qon:177 (%s)\n", caller);
...
//Building function stringify from line: 189

char* stringify(box b) {
  
if (globalTrace)
    printf("stringify at q/base.qon:189 (%s)\n", caller);
...
if (globalTrace)
    snprintf(caller, 1024, "from q/base.qon:194");
    if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);
...
//Building function hasTag from line: 223

bool hasTag(box aBox, box key) {
  
if (globalTrace)
    printf("hasTag at q/base.qon:223 (%s)\n", caller);
...
//Building function getTag from line: 229

box getTag(box aBox, box key) {
  
if (globalTrace)
    printf("getTag at q/base.qon:229 (%s)\n", caller);
...
//Building function getTagFail from line: 241

box getTagFail(box aBox, box key, box onFail) {
  
if (globalTrace)
    printf("getTagFail at q/base.qon:241 (%s)\n", caller);
...
if (globalTrace)
    printf("assocExists at q/base.qon:247 (%s)\n", caller);
...
//Building function assocFail from line: 256

box assocFail(char* key, box aBox, box onFail) {
  
if (globalTrace)
    printf("assocFail at q/base.qon:256 (%s)\n", caller);
...
if (globalTrace)
    printf("assocPanic at q/base.qon:262 (%s)\n", caller);
...
//Building function locPanic from line: 292

void locPanic(char* file, char* line, char* message) {
  
if (globalTrace)
    printf("locPanic at q/base.qon:292 (%s)\n", caller);
...
//Building function truthy from line: 318

bool truthy(box aVal) {
  
if (globalTrace)
    printf("truthy at q/base.qon:318 (%s)\n", caller);

if (globalTrace)
    snprintf(caller, 1024, "from q/base.qon:320");
  if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);
...
//Building function isNotFalse from line: 322

bool isNotFalse(box aVal) {
  
if (globalTrace)
    printf("isNotFalse at q/base.qon:322 (%s)\n", caller);
...
//Building function toStr from line: 330

box toStr(box thing) {
  
if (globalTrace)
    printf("toStr at q/base.qon:330 (%s)\n", caller);
...
//Building function listLast from line: 333

box listLast(list alist) {
  
if (globalTrace)
    printf("listLast at q/base.qon:333 (%s)\n", caller);
...
//Building function newLine from line: 341

void newLine(int indent) {
  
if (globalTrace)
    printf("newLine at q/base.qon:341 (%s)\n", caller);
...
//Building function printIndent from line: 347
...
if (globalTrace)
    snprintf(caller, 1024, "from q/base.qon:353");
    if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);
...
//Building function argList from line: 364

list argList(int count, int pos, char** args) {
  
if (globalTrace)
    printf("argList at q/base.qon:364 (%s)\n", caller);
...
if (globalTrace)
    snprintf(caller, 1024, "from q/base.qon:372");
    if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);
...
//Building function tron from line: 374

void tron() {
  
if (globalTrace)
    printf("tron at q/base.qon:374 (%s)\n", caller);
...
//Building function troff from line: 375

void troff() {
  
if (globalTrace)
    printf("troff at q/base.qon:375 (%s)\n", caller);
...
//Building function stron from line: 376

void stron() {
  
if (globalTrace)
    printf("stron at q/base.qon:376 (%s)\n", caller);

if (globalTrace)
    snprintf(caller, 1024, "from q/base.qon:376");
  if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);
...
//Building function stroff from line: 377

void stroff() {
  
if (globalTrace)
    printf("stroff at q/base.qon:377 (%s)\n", caller);
