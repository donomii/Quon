...
//Building function bashRecurList from line: 92

void bashRecurList(list expr, int indent) {
  
if (globalTrace)
    printf("bashRecurList at q/bash.qon:92 (%s)\n", caller);
...
//Building function bashIf from line: 109

void bashIf(list node, int indent) {
  
if (globalTrace)
    printf("bashIf at q/bash.qon:109 (%s)\n", caller);
...
//Building function bashSetStruct from line: 122

void bashSetStruct(list node, int indent) {
  
if (globalTrace)
    printf("bashSetStruct at q/bash.qon:122 (%s)\n", caller);
...
//Building function bashGetStruct from line: 131

void bashGetStruct(list node, int indent) {
  
if (globalTrace)
    printf("bashGetStruct at q/bash.qon:131 (%s)\n", caller);
...
//Building function bashSet from line: 139

void bashSet(list node, int indent) {
  
if (globalTrace)
    printf("bashSet at q/bash.qon:139 (%s)\n", caller);
...
if (globalTrace)
  ...
  bashExpression(first(cdr(node)), indent);
...
//Building function bashReturn from line: 146

void bashReturn(list node, int indent) {
  
if (globalTrace)
    printf("bashReturn at q/bash.qon:146 (%s)\n", caller);

if (globalTrace)
    snprintf(caller, 1024, "from q/bash.qon:148");
  if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);
...
//Building function bashStatement from line: 157

void bashStatement(list node, int indent) {
  
if (globalTrace)
    printf("bashStatement at q/bash.qon:157 (%s)\n", caller);
...
//Building function bashBody from line: 175

void bashBody(list tree, int indent) {
  list code = NULL;

if (globalTrace)
    printf("bashBody at q/bash.qon:175 (%s)\n", caller);
...
if (globalTrace)
    snprintf(caller, 1024, "from q/bash.qon:198");
    if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);
...
//Building function bashDeclarations from line: 200

void bashDeclarations(list decls, int indent) {
  box decl = NULL;

if (globalTrace)
    printf("bashDeclarations at q/bash.qon:200 (%s)\n", caller);
...
//Building function bashFunction from line: 213

void bashFunction(list node) {
  box name = NULL;

if (globalTrace)
    printf("bashFunction at q/bash.qon:213 (%s)\n", caller);
...
//Building function bashForwardDeclaration from line: 245

void bashForwardDeclaration(list node) {
  
if (globalTrace)
    printf("bashForwardDeclaration at q/bash.qon:245 (%s)\n", caller);
...
//Building function bashForwardDeclarations from line: 255

void bashForwardDeclarations(list tree) {
  
if (globalTrace)
    printf("bashForwardDeclarations at q/bash.qon:255 (%s)\n", caller);
...
//Building function bashFunctions from line: 261

void bashFunctions(list tree) {
  
if (globalTrace)
    printf("bashFunctions at q/bash.qon:261 (%s)\n", caller);
...
//Building function bashIncludes from line: 267

void bashIncludes(list nodes) {
  
if (globalTrace)
    printf("bashIncludes at q/bash.qon:267 (%s)\n", caller);
...
//Building function bashTypeDecl from line: 275

void bashTypeDecl(list l) {
  
if (globalTrace)
    printf("bashTypeDecl at q/bash.qon:275 (%s)\n", caller);

if (globalTrace)
    snprintf(caller, 1024, "from q/bash.qon:277");
  if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);
...
if (globalTrace)
    snprintf(caller, 1024, "from q/bash.qon:280");
    if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);
...
//Building function bashStructComponents from line: 292

void bashStructComponents(list node) {
  
if (globalTrace)
    printf("bashStructComponents at q/bash.qon:292 (%s)\n", caller);
...
//Building function bashStruct from line: 298

void bashStruct(list node) {
  
if (globalTrace)
    printf("bashStruct at q/bash.qon:298 (%s)\n", caller);
...
//Building function bashTypeMap from line: 301

box bashTypeMap(box aSym) {
  list symMap = NULL;

if (globalTrace)
    printf("bashTypeMap at q/bash.qon:301 (%s)\n", caller);
...
//Building function bashFuncMap from line: 311

box bashFuncMap(box aSym) {
  list symMap = NULL;

if (globalTrace)
    printf("bashFuncMap at q/bash.qon:311 (%s)\n", caller);

if (globalTrace)
    snprintf(caller, 1024, "from q/bash.qon:313");
  if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);
...
if (globalTrace)
    snprintf(caller, 1024, "from q/bash.qon:337");
    if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);

    if ( truthy(assoc(stringify(aSym), symMap))) {
if (globalTrace)
    snprintf(caller, 1024, "from q/bash.qon:338");
      if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);
...
//Building function bashType from line: 342

void bashType(list node) {
  
if (globalTrace)
    printf("bashType at q/bash.qon:342 (%s)\n", caller);

if (globalTrace)
    snprintf(caller, 1024, "from q/bash.qon:344");
  if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);
...
//Building function bashTypes from line: 352

void bashTypes(list nodes) {
  
if (globalTrace)
    printf("bashTypes at q/bash.qon:352 (%s)\n", caller);
...
//Building function bashCompile from line: 362
...
if (globalTrace)
    printf("bashCompile at q/bash.qon:362 (%s)\n", caller);
...
if (globalTrace)
    snprintf(caller, 1024, "from q/bash.qon:375");
  if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);
...
if (globalTrace)
    snprintf(caller, 1024, "from q/bash.qon:377");
  if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);
...
if (globalTrace)
    snprintf(caller, 1024, "from q/bash.qon:389");
  if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);

  bashdisplays("\nbool isNil(list p) {\n    return p == NULL;\n}\n\n\n//Forward declarations\n");

if (globalTrace)
    snprintf(caller, 1024, "from q/bash.qon:391");
  if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);

  bashForwardDeclarations(cdr(third(tree)));

if (globalTrace)
    snprintf(caller, 1024, "from q/bash.qon:392");
  if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);

  bashdisplays("\n\n//End forward declarations\n\n");

if (globalTrace)
    snprintf(caller, 1024, "from q/bash.qon:393");
  if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);
