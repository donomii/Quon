...
if ($globalTrace) { printf("equalBox at q/base.qon:58\n") }
  if ($globalStepTrace) {printf("StepTrace %s:%d\n", __FILE__, __LINE__)}
...
if ($globalTrace) { printf("display at q/base.qon:79\n") }
  if ($globalStepTrace) {printf("StepTrace %s:%d\n", __FILE__, __LINE__)}
...
if ($globalTrace) { printf("boxType at q/base.qon:97\n") }
  if ($globalStepTrace) {printf("StepTrace %s:%d\n", __FILE__, __LINE__)}
...
if ($globalTrace) { printf("makeBox at q/base.qon:100\n") }
  if ($globalStepTrace) {printf("StepTrace %s:%d\n", __FILE__, __LINE__)}
...
if ($globalTrace) { printf("makePair at q/base.qon:115\n") }
  if ($globalStepTrace) {printf("StepTrace %s:%d\n", __FILE__, __LINE__)}
...
if ($globalTrace) { printf("boxString at q/base.qon:121\n") }
  if ($globalStepTrace) {printf("StepTrace %s:%d\n", __FILE__, __LINE__)}
...
if ($globalTrace) { printf("boxSymbol at q/base.qon:131\n") }
  if ($globalStepTrace) {printf("StepTrace %s:%d\n", __FILE__, __LINE__)}
...
if ($globalTrace) { printf("boxBool at q/base.qon:140\n") }
  if ($globalStepTrace) {printf("StepTrace %s:%d\n", __FILE__, __LINE__)}
...
if ($globalTrace) { printf("boxInt at q/base.qon:149\n") }
  if ($globalStepTrace) {printf("StepTrace %s:%d\n", __FILE__, __LINE__)}
...
if ($globalTrace) { printf("assertType at q/base.qon:158\n") }
  if ($globalStepTrace) {printf("StepTrace %s:%d\n", __FILE__, __LINE__)}
...
if ($globalTrace) { printf("unBoxString at q/base.qon:170\n") }
  if ($globalStepTrace) {printf("StepTrace %s:%d\n", __FILE__, __LINE__)}
...
if ($globalTrace) { printf("unBoxSymbol at q/base.qon:173\n") }
  if ($globalStepTrace) {printf("StepTrace %s:%d\n", __FILE__, __LINE__)}
...
if ($globalTrace) { printf("unBoxBool at q/base.qon:174\n") }
  if ($globalStepTrace) {printf("StepTrace %s:%d\n", __FILE__, __LINE__)}
...
if ($globalTrace) { printf("unBoxInt at q/base.qon:175\n") }
  if ($globalStepTrace) {printf("StepTrace %s:%d\n", __FILE__, __LINE__)}
...
if ($globalTrace) { printf("stringify_rec at q/base.qon:177\n") }
  if ($globalStepTrace) {printf("StepTrace %s:%d\n", __FILE__, __LINE__)}
...
if ($globalTrace) { printf("stringify at q/base.qon:189\n") }
  if ($globalStepTrace) {printf("StepTrace %s:%d\n", __FILE__, __LINE__)}
...
if ($globalTrace) { printf("hasTag at q/base.qon:223\n") }
  if ($globalStepTrace) {printf("StepTrace %s:%d\n", __FILE__, __LINE__)}
...
if ($globalTrace) { printf("getTag at q/base.qon:229\n") }
  if ($globalStepTrace) {printf("StepTrace %s:%d\n", __FILE__, __LINE__)}
...
if ($globalTrace) { printf("getTagFail at q/base.qon:241\n") }
  if ($globalStepTrace) {printf("StepTrace %s:%d\n", __FILE__, __LINE__)}
...
if ($globalTrace) { printf("assocFail at q/base.qon:256\n") }
  if ($globalStepTrace) {printf("StepTrace %s:%d\n", __FILE__, __LINE__)}
...
if ($globalTrace) { printf("locPanic at q/base.qon:292\n") }
  if ($globalStepTrace) {printf("StepTrace %s:%d\n", __FILE__, __LINE__)}
...
if ($globalTrace) { printf("truthy at q/base.qon:318\n") }
  if ($globalStepTrace) {printf("StepTrace %s:%d\n", __FILE__, __LINE__)}
...
if ($globalTrace) { printf("isNotFalse at q/base.qon:322\n") }
  if ($globalStepTrace) {printf("StepTrace %s:%d\n", __FILE__, __LINE__)}
...
if ($globalTrace) { printf("toStr at q/base.qon:330\n") }
  if ($globalStepTrace) {printf("StepTrace %s:%d\n", __FILE__, __LINE__)}
...
if ($globalTrace) { printf("listLast at q/base.qon:333\n") }
  if ($globalStepTrace) {printf("StepTrace %s:%d\n", __FILE__, __LINE__)}
...
if ($globalTrace) { printf("newLine at q/base.qon:341\n") }
  if ($globalStepTrace) {printf("StepTrace %s:%d\n", __FILE__, __LINE__)}
...
if ($globalTrace) { printf("printIndent at q/base.qon:347\n") }
  if ($globalStepTrace) {printf("StepTrace %s:%d\n", __FILE__, __LINE__)}
...
if ($globalTrace) { printf("argList at q/base.qon:364\n") }
  if ($globalStepTrace) {printf("StepTrace %s:%d\n", __FILE__, __LINE__)}
...
if ($globalTrace) { printf("tron at q/base.qon:374\n") }
  if ($globalStepTrace) {printf("StepTrace %s:%d\n", __FILE__, __LINE__)}
...
if ($globalTrace) { printf("troff at q/base.qon:375\n") }
  if ($globalStepTrace) {printf("StepTrace %s:%d\n", __FILE__, __LINE__)}
...
if ($globalTrace) { printf("stron at q/base.qon:376\n") }
  if ($globalStepTrace) {printf("StepTrace %s:%d\n", __FILE__, __LINE__)}
...
if ($globalTrace) { printf("stroff at q/base.qon:377\n") }
  if ($globalStepTrace) {printf("StepTrace %s:%d\n", __FILE__, __LINE__)}
...
if ($globalTrace) { printf("filterVoid at q/compiler.qon:11\n") }
  if ($globalStepTrace) {printf("StepTrace %s:%d\n", __FILE__, __LINE__)}
...
if ($globalTrace) { printf("filterTokens at q/compiler.qon:23\n") }
  if ($globalStepTrace) {printf("StepTrace %s:%d\n", __FILE__, __LINE__)}
...
if ($globalTrace) { printf("finish_token at q/compiler.qon:57\n") }
  if ($globalStepTrace) {printf("StepTrace %s:%d\n", __FILE__, __LINE__)}
...
if ($globalTrace) { printf("readString at q/compiler.qon:72\n") }
  if ($globalStepTrace) {printf("StepTrace %s:%d\n", __FILE__, __LINE__)}
...
if ($globalTrace) { printf("readComment at q/compiler.qon:83\n") }
  if ($globalStepTrace) {printf("StepTrace %s:%d\n", __FILE__, __LINE__)}
...
if ($globalTrace) { printf("isOpenBrace at q/compiler.qon:176\n") }
  if ($globalStepTrace) {printf("StepTrace %s:%d\n", __FILE__, __LINE__)}
...
if ($globalTrace) { printf("isCloseBrace at q/compiler.qon:185\n") }
  if ($globalStepTrace) {printf("StepTrace %s:%d\n", __FILE__, __LINE__)}
...
if ($globalTrace) { printf("skipList at q/compiler.qon:198\n") }
  if ($globalStepTrace) {printf("StepTrace %s:%d\n", __FILE__, __LINE__)}
...
if ($globalTrace) { printf("makeNode at q/compiler.qon:223\n") }
  if ($globalStepTrace) {printf("StepTrace %s:%d\n", __FILE__, __LINE__)}
...
if ($globalTrace) { printf("addToNode at q/compiler.qon:239\n") }
  if ($globalStepTrace) {printf("StepTrace %s:%d\n", __FILE__, __LINE__)}
...
if ($globalTrace) { printf("makeStatementNode at q/compiler.qon:244\n") }
  if ($globalStepTrace) {printf("StepTrace %s:%d\n", __FILE__, __LINE__)}
...
if ($globalTrace) { printf("astExpression at q/compiler.qon:249\n") }
  if ($globalStepTrace) {printf("StepTrace %s:%d\n", __FILE__, __LINE__)}
...
if ($globalTrace) { printf("astSubExpression at q/compiler.qon:257\n") }
  if ($globalStepTrace) {printf("StepTrace %s:%d\n", __FILE__, __LINE__)}
...
if ($globalTrace) { printf("astIf at q/compiler.qon:268\n") }
  if ($globalStepTrace) {printf("StepTrace %s:%d\n", __FILE__, __LINE__)}
...
if ($globalTrace) { printf("astSetStruct at q/compiler.qon:289\n") }
  if ($globalStepTrace) {printf("StepTrace %s:%d\n", __FILE__, __LINE__)}
...
if ($globalTrace) { printf("astSet at q/compiler.qon:294\n") }
  if ($globalStepTrace) {printf("StepTrace %s:%d\n", __FILE__, __LINE__)}
...
if ($globalTrace) { printf("astGetStruct at q/compiler.qon:299\n") }
  if ($globalStepTrace) {printf("StepTrace %s:%d\n", __FILE__, __LINE__)}
...
if ($globalTrace) { printf("astReturnVoid at q/compiler.qon:302\n") }
  if ($globalStepTrace) {printf("StepTrace %s:%d\n", __FILE__, __LINE__)}
...
if ($globalTrace) { printf("astStatement at q/compiler.qon:306\n") }
  if ($globalStepTrace) {printf("StepTrace %s:%d\n", __FILE__, __LINE__)}
...
if ($globalTrace) { printf("astBody at q/compiler.qon:344\n") }
  if ($globalStepTrace) {printf("StepTrace %s:%d\n", __FILE__, __LINE__)}
...
if ($globalTrace) { printf("astFunction at q/compiler.qon:352\n") }
  if ($globalStepTrace) {printf("StepTrace %s:%d\n", __FILE__, __LINE__)}
...
if ($globalTrace) { printf("astFunctionList at q/compiler.qon:387\n") }
  if ($globalStepTrace) {printf("StepTrace %s:%d\n", __FILE__, __LINE__)}
...
if ($globalTrace) { printf("astFunctions at q/compiler.qon:395\n") }
  if ($globalStepTrace) {printf("StepTrace %s:%d\n", __FILE__, __LINE__)}
...
if ($globalTrace) { printf("loadLib at q/compiler.qon:403\n") }
  if ($globalStepTrace) {printf("StepTrace %s:%d\n", __FILE__, __LINE__)}
...
if ($globalTrace) { printf("astInclude at q/compiler.qon:420\n") }
  if ($globalStepTrace) {printf("StepTrace %s:%d\n", __FILE__, __LINE__)}
...
if ($globalTrace) { printf("astIncludeList at q/compiler.qon:423\n") }
  if ($globalStepTrace) {printf("StepTrace %s:%d\n", __FILE__, __LINE__)}
...
if ($globalTrace) { printf("astIncludes at q/compiler.qon:430\n") }
  if ($globalStepTrace) {printf("StepTrace %s:%d\n", __FILE__, __LINE__)}
...
if ($globalTrace) { printf("astStruct at q/compiler.qon:439\n") }
  if ($globalStepTrace) {printf("StepTrace %s:%d\n", __FILE__, __LINE__)}
...
if ($globalTrace) { printf("astType at q/compiler.qon:442\n") }
  if ($globalStepTrace) {printf("StepTrace %s:%d\n", __FILE__, __LINE__)}
...
if ($globalTrace) { printf("astTypeList at q/compiler.qon:448\n") }
  if ($globalStepTrace) {printf("StepTrace %s:%d\n", __FILE__, __LINE__)}
...
if ($globalTrace) { printf("astTypes at q/compiler.qon:454\n") }
  if ($globalStepTrace) {printf("StepTrace %s:%d\n", __FILE__, __LINE__)}
...
if ($globalTrace) { printf("declarationsof at q/compiler.qon:472\n") }
  if ($globalStepTrace) {printf("StepTrace %s:%d\n", __FILE__, __LINE__)}
...
if ($globalTrace) { printf("codeof at q/compiler.qon:475\n") }
  if ($globalStepTrace) {printf("StepTrace %s:%d\n", __FILE__, __LINE__)}
...
if ($globalTrace) { printf("functionNameof at q/compiler.qon:478\n") }
  if ($globalStepTrace) {printf("StepTrace %s:%d\n", __FILE__, __LINE__)}
...
if ($globalTrace) { printf("nodeof at q/compiler.qon:481\n") }
  if ($globalStepTrace) {printf("StepTrace %s:%d\n", __FILE__, __LINE__)}
...
if ($globalTrace) { printf("lineof at q/compiler.qon:489\n") }
  if ($globalStepTrace) {printf("StepTrace %s:%d\n", __FILE__, __LINE__)}
...
if ($globalTrace) { printf("subnameof at q/compiler.qon:494\n") }
  if ($globalStepTrace) {printf("StepTrace %s:%d\n", __FILE__, __LINE__)}
...
if ($globalTrace) { printf("nameof at q/compiler.qon:497\n") }
  if ($globalStepTrace) {printf("StepTrace %s:%d\n", __FILE__, __LINE__)}
...
if ($globalTrace) { printf("childrenof at q/compiler.qon:500\n") }
  if ($globalStepTrace) {printf("StepTrace %s:%d\n", __FILE__, __LINE__)}
...
if ($globalTrace) { printf("isNode at q/compiler.qon:504\n") }
  if ($globalStepTrace) {printf("StepTrace %s:%d\n", __FILE__, __LINE__)}
...
if ($globalTrace) { printf("isLeaf at q/compiler.qon:520\n") }
  if ($globalStepTrace) {printf("StepTrace %s:%d\n", __FILE__, __LINE__)}
...
if ($globalTrace) { printf("noStackTrace at q/compiler.qon:523\n") }
  if ($globalStepTrace) {printf("StepTrace %s:%d\n", __FILE__, __LINE__)}
...
if ($globalTrace) { printf("treeCompile at q/compiler.qon:555\n") }
  if ($globalStepTrace) {printf("StepTrace %s:%d\n", __FILE__, __LINE__)}
...
if ($globalTrace) { printf("astBuild at q/compiler.qon:561\n") }
  if ($globalStepTrace) {printf("StepTrace %s:%d\n", __FILE__, __LINE__)}
...
if ($globalTrace) { printf("astCompile at q/compiler.qon:578\n") }
  if ($globalStepTrace) {printf("StepTrace %s:%d\n", __FILE__, __LINE__)}
...
if ($globalTrace) { printf("mergeIncludes at q/compiler.qon:604\n") }
  if ($globalStepTrace) {printf("StepTrace %s:%d\n", __FILE__, __LINE__)}
...
if ($globalTrace) { printf("merge_recur at q/compiler.qon:611\n") }
  if ($globalStepTrace) {printf("StepTrace %s:%d\n", __FILE__, __LINE__)}
...
if ($globalTrace) { printf("mergeInclude at q/compiler.qon:619\n") }
  if ($globalStepTrace) {printf("StepTrace %s:%d\n", __FILE__, __LINE__)}
...
if ($globalTrace) { printf("perlTypeDecl at q/perl.qon:306\n") }
...
if ($globalTrace) { printf("perlStructComponents at q/perl.qon:311\n") }
  if ($globalStepTrace) {printf("StepTrace %s:%d\n", __FILE__, __LINE__)}
...
if ($globalTrace) { printf("perlStruct at q/perl.qon:317\n") }
  if ($globalStepTrace) {printf("StepTrace %s:%d\n", __FILE__, __LINE__)}
...
if ($globalTrace) { printf("perlTypeMap at q/perl.qon:320\n") }
  if ($globalStepTrace) {printf("StepTrace %s:%d\n", __FILE__, __LINE__)}
...
if ($globalTrace) { printf("perlConstMap at q/perl.qon:332\n") }
  if ($globalStepTrace) {printf("StepTrace %s:%d\n", __FILE__, __LINE__)}
...
if ($globalTrace) { printf("perlFuncMap at q/perl.qon:342\n") }
  if ($globalStepTrace) {printf("StepTrace %s:%d\n", __FILE__, __LINE__)}
...
if ($globalTrace) { printf("perlType at q/perl.qon:359\n") }
...
if ($globalTrace) { printf("perlTypes at q/perl.qon:364\n") }
  if ($globalStepTrace) {printf("StepTrace %s:%d\n", __FILE__, __LINE__)}
...
if ($globalTrace) { printf("perlFunctionArgs at q/perl.qon:370\n") }
  if ($globalStepTrace) {printf("StepTrace %s:%d\n", __FILE__, __LINE__)}
...
if ($globalTrace) { printf("perlCompile at q/perl.qon:380\n") }
  if ($globalStepTrace) {printf("StepTrace %s:%d\n", __FILE__, __LINE__)}
...
if ($globalTrace) { printf("ansiTypeDecl at q/ansi.qon:241\n") }
  if ($globalStepTrace) {printf("StepTrace %s:%d\n", __FILE__, __LINE__)}
...
if ($globalTrace) { printf("ansiStructComponents at q/ansi.qon:258\n") }
  if ($globalStepTrace) {printf("StepTrace %s:%d\n", __FILE__, __LINE__)}
...
if ($globalTrace) { printf("ansiStruct at q/ansi.qon:264\n") }
  if ($globalStepTrace) {printf("StepTrace %s:%d\n", __FILE__, __LINE__)}
...
if ($globalTrace) { printf("ansiTypeMap at q/ansi.qon:267\n") }
  if ($globalStepTrace) {printf("StepTrace %s:%d\n", __FILE__, __LINE__)}
...
if ($globalTrace) { printf("ansiFuncMap at q/ansi.qon:279\n") }
  if ($globalStepTrace) {printf("StepTrace %s:%d\n", __FILE__, __LINE__)}
...
if ($globalTrace) { printf("ansiType at q/ansi.qon:310\n") }
  if ($globalStepTrace) {printf("StepTrace %s:%d\n", __FILE__, __LINE__)}
...
if ($globalTrace) { printf("ansiTypes at q/ansi.qon:320\n") }
  if ($globalStepTrace) {printf("StepTrace %s:%d\n", __FILE__, __LINE__)}
...
if ($globalTrace) { printf("ansiCompile at q/ansi.qon:330\n") }
  if ($globalStepTrace) {printf("StepTrace %s:%d\n", __FILE__, __LINE__)}
...
if ($globalTrace) { printf("ansi2TypeDecl at q/ansi2.qon:291\n") }
  if ($globalStepTrace) {printf("StepTrace %s:%d\n", __FILE__, __LINE__)}
...
if ($globalTrace) { printf("ansi2StructComponents at q/ansi2.qon:308\n") }
  if ($globalStepTrace) {printf("StepTrace %s:%d\n", __FILE__, __LINE__)}
...
if ($globalTrace) { printf("ansi2Struct at q/ansi2.qon:314\n") }
  if ($globalStepTrace) {printf("StepTrace %s:%d\n", __FILE__, __LINE__)}
...
if ($globalTrace) { printf("ansi2TypeMap at q/ansi2.qon:317\n") }
  if ($globalStepTrace) {printf("StepTrace %s:%d\n", __FILE__, __LINE__)}
...
if ($globalTrace) { printf("ansi2FuncMap at q/ansi2.qon:329\n") }
  if ($globalStepTrace) {printf("StepTrace %s:%d\n", __FILE__, __LINE__)}
...
if ($globalTrace) { printf("ansi2Type at q/ansi2.qon:360\n") }
  if ($globalStepTrace) {printf("StepTrace %s:%d\n", __FILE__, __LINE__)}
...
if ($globalTrace) { printf("ansi2Types at q/ansi2.qon:370\n") }
  if ($globalStepTrace) {printf("StepTrace %s:%d\n", __FILE__, __LINE__)}
...
if ($globalTrace) { printf("ansi2Compile at q/ansi2.qon:380\n") }
  if ($globalStepTrace) {printf("StepTrace %s:%d\n", __FILE__, __LINE__)}
...
if ($globalTrace) { printf("ansi3Declarations at q/ansi3.qon:216\n") }
  if ($globalStepTrace) {printf("StepTrace %s:%d\n", __FILE__, __LINE__)}
...
if ($globalTrace) { printf("ansi3Function at q/ansi3.qon:230\n") }
  if ($globalStepTrace) {printf("StepTrace %s:%d\n", __FILE__, __LINE__)}
...
if ($globalTrace) { printf("ansi3ForwardDeclaration at q/ansi3.qon:267\n") }
  if ($globalStepTrace) {printf("StepTrace %s:%d\n", __FILE__, __LINE__)}
...
if ($globalTrace) { printf("ansi3ForwardDeclarations at q/ansi3.qon:277\n") }
  if ($globalStepTrace) {printf("StepTrace %s:%d\n", __FILE__, __LINE__)}
...
if ($globalTrace) { printf("ansi3Functions at q/ansi3.qon:283\n") }
  if ($globalStepTrace) {printf("StepTrace %s:%d\n", __FILE__, __LINE__)}
...
if ($globalTrace) { printf("ansi3Includes at q/ansi3.qon:289\n") }
  if ($globalStepTrace) {printf("StepTrace %s:%d\n", __FILE__, __LINE__)}
...
if ($globalTrace) { printf("ansi3TypeDecl at q/ansi3.qon:297\n") }
  if ($globalStepTrace) {printf("StepTrace %s:%d\n", __FILE__, __LINE__)}
...
if ($globalTrace) { printf("ansi3StructComponents at q/ansi3.qon:314\n") }
  if ($globalStepTrace) {printf("StepTrace %s:%d\n", __FILE__, __LINE__)}
...
if ($globalTrace) { printf("ansi3Struct at q/ansi3.qon:320\n") }
  if ($globalStepTrace) {printf("StepTrace %s:%d\n", __FILE__, __LINE__)}
...
if ($globalTrace) { printf("ansi3TypeMap at q/ansi3.qon:323\n") }
  if ($globalStepTrace) {printf("StepTrace %s:%d\n", __FILE__, __LINE__)}
...
if ($globalTrace) { printf("ansi3FuncMap at q/ansi3.qon:333\n") }
  if ($globalStepTrace) {printf("StepTrace %s:%d\n", __FILE__, __LINE__)}
...
if ($globalTrace) { printf("ansi3Type at q/ansi3.qon:364\n") }
  if ($globalStepTrace) {printf("StepTrace %s:%d\n", __FILE__, __LINE__)}
...
if ($globalTrace) { printf("ansi3Types at q/ansi3.qon:374\n") }
  if ($globalStepTrace) {printf("StepTrace %s:%d\n", __FILE__, __LINE__)}
...
if ($globalTrace) { printf("ansi3Compile at q/ansi3.qon:384\n") }
  if ($globalStepTrace) {printf("StepTrace %s:%d\n", __FILE__, __LINE__)}
...
if ($globalTrace) { printf("test4 at q/tests.qon:45\n") }
  if ($globalStepTrace) {printf("StepTrace %s:%d\n", __FILE__, __LINE__)}
...
if ($globalTrace) { printf("test5 at q/tests.qon:48\n") }
  if ($globalStepTrace) {printf("StepTrace %s:%d\n", __FILE__, __LINE__)}
...
if ($globalTrace) { printf("test6 at q/tests.qon:53\n") }
  if ($globalStepTrace) {printf("StepTrace %s:%d\n", __FILE__, __LINE__)}
...
if ($globalTrace) { printf("test7_do at q/tests.qon:61\n") }
  if ($globalStepTrace) {printf("StepTrace %s:%d\n", __FILE__, __LINE__)}
...
if ($globalTrace) { printf("test7 at q/tests.qon:69\n") }
  if ($globalStepTrace) {printf("StepTrace %s:%d\n", __FILE__, __LINE__)}
...
if ($globalTrace) { printf("beer at q/tests.qon:77\n") }
  if ($globalStepTrace) {printf("StepTrace %s:%d\n", __FILE__, __LINE__)}
...
if ($globalTrace) { printf("plural at q/tests.qon:86\n") }
  if ($globalStepTrace) {printf("StepTrace %s:%d\n", __FILE__, __LINE__)}
...
if ($globalTrace) { printf("beers at q/tests.qon:91\n") }
  if ($globalStepTrace) {printf("StepTrace %s:%d\n", __FILE__, __LINE__)}
...
if ($globalTrace) { printf("test8 at q/tests.qon:107\n") }
  if ($globalStepTrace) {printf("StepTrace %s:%d\n", __FILE__, __LINE__)}
...
if ($globalTrace) { printf("test9 at q/tests.qon:115\n") }
  if ($globalStepTrace) {printf("StepTrace %s:%d\n", __FILE__, __LINE__)}
...
if ($globalTrace) { printf("test10 at q/tests.qon:173\n") }
  if ($globalStepTrace) {printf("StepTrace %s:%d\n", __FILE__, __LINE__)}
...
if ($globalTrace) { printf("test12 at q/tests.qon:183\n") }
  if ($globalStepTrace) {printf("StepTrace %s:%d\n", __FILE__, __LINE__)}
...
if ($globalTrace) { printf("test13 at q/tests.qon:191\n") }
  if ($globalStepTrace) {printf("StepTrace %s:%d\n", __FILE__, __LINE__)}
...
if ($globalTrace) { printf("test15 at q/tests.qon:207\n") }
  if ($globalStepTrace) {printf("StepTrace %s:%d\n", __FILE__, __LINE__)}
...
if ($globalTrace) { printf("test16 at q/tests.qon:215\n") }
  if ($globalStepTrace) {printf("StepTrace %s:%d\n", __FILE__, __LINE__)}
...
if ($globalTrace) { printf("test17 at q/tests.qon:239\n") }
  if ($globalStepTrace) {printf("StepTrace %s:%d\n", __FILE__, __LINE__)}
...
if ($globalTrace) { printf("test18 at q/tests.qon:250\n") }
  if ($globalStepTrace) {printf("StepTrace %s:%d\n", __FILE__, __LINE__)}
...
if ($globalTrace) { printf("test19 at q/tests.qon:264\n") }
  if ($globalStepTrace) {printf("StepTrace %s:%d\n", __FILE__, __LINE__)}
...
if ($globalTrace) { printf("concatenateLists at q/tests.qon:282\n") }
  if ($globalStepTrace) {printf("StepTrace %s:%d\n", __FILE__, __LINE__)}
...
if ($globalTrace) { printf("test20 at q/tests.qon:287\n") }
  if ($globalStepTrace) {printf("StepTrace %s:%d\n", __FILE__, __LINE__)}
...
if ($globalTrace) { printf("test21 at q/tests.qon:307\n") }
  if ($globalStepTrace) {printf("StepTrace %s:%d\n", __FILE__, __LINE__)}
...
if ($globalTrace) { printf("test22 at q/tests.qon:323\n") }
  if ($globalStepTrace) {printf("StepTrace %s:%d\n", __FILE__, __LINE__)}
...
if ($globalTrace) { printf("test23 at q/tests.qon:346\n") }
  if ($globalStepTrace) {printf("StepTrace %s:%d\n", __FILE__, __LINE__)}
...
if ($globalTrace) { printf("javaTypes at q/java.qon:335\n") }
  if ($globalStepTrace) {printf("StepTrace %s:%d\n", __FILE__, __LINE__)}
...
if ($globalTrace) { printf("javaCompile at q/java.qon:341\n") }
  if ($globalStepTrace) {printf("StepTrace %s:%d\n", __FILE__, __LINE__)}
