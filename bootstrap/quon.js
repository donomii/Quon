...
if (globalTrace)
    {printf("hasTag at q/base.qon:219\n");}
  if (globalStepTrace) {console.log(new Error("StepTrace \n"));}
...
if (globalTrace)
    {printf("getTag at q/base.qon:225\n");}
  if (globalStepTrace) {console.log(new Error("StepTrace \n"));}
...
if (globalTrace)
    {printf("getTagFail at q/base.qon:237\n");}
  if (globalStepTrace) {console.log(new Error("StepTrace \n"));}
...
if (globalTrace)
    {printf("assocExists at q/base.qon:243\n");}
  if (globalStepTrace) {console.log(new Error("StepTrace \n"));}
...
if (globalTrace)
    {printf("assocFail at q/base.qon:252\n");}
  if (globalStepTrace) {console.log(new Error("StepTrace \n"));}
...
if (globalTrace)
    {printf("assocPanic at q/base.qon:258\n");}
  if (globalStepTrace) {console.log(new Error("StepTrace \n"));}
...
if (globalTrace)
    {printf("setTag at q/base.qon:271\n");}
  if (globalStepTrace) {console.log(new Error("StepTrace \n"));}
...
if (globalTrace)
    {printf("filterVoid at q/base.qon:284\n");}
  if (globalStepTrace) {console.log(new Error("StepTrace \n"));}
...
if (globalTrace)
    {printf("filterTokens at q/base.qon:296\n");}
  if (globalStepTrace) {console.log(new Error("StepTrace \n"));}
...
if (globalTrace)
    {printf("finish_token at q/base.qon:330\n");}
  if (globalStepTrace) {console.log(new Error("StepTrace \n"));}
...
if (globalTrace)
    {printf("readString at q/base.qon:345\n");}
  if (globalStepTrace) {console.log(new Error("StepTrace \n"));}
...
if (globalTrace)
    {printf("readComment at q/base.qon:356\n");}
  if (globalStepTrace) {console.log(new Error("StepTrace \n"));}
...
if (globalTrace)
    {printf("isWhiteSpace at q/base.qon:364\n");}
  if (globalStepTrace) {console.log(new Error("StepTrace \n"));}
...
if (globalTrace)
    {printf("isLineBreak at q/base.qon:381\n");}
  if (globalStepTrace) {console.log(new Error("StepTrace \n"));}
...
if (globalTrace)
    {printf("incForNewLine at q/base.qon:388\n");}
  if (globalStepTrace) {console.log(new Error("StepTrace \n"));}
...
if (globalTrace)
    {printf("annotateReadPosition at q/base.qon:396\n");}
  if (globalStepTrace) {console.log(new Error("StepTrace \n"));}
...
if (globalTrace)
    {printf("isOpenBrace at q/base.qon:449\n");}
  if (globalStepTrace) {console.log(new Error("StepTrace \n"));}
...
if (globalTrace)
    {printf("openBrace at q/base.qon:457\n");}
  if (globalStepTrace) {console.log(new Error("StepTrace \n"));}
...
if (globalTrace)
    {printf("isCloseBrace at q/base.qon:459\n");}
  if (globalStepTrace) {console.log(new Error("StepTrace \n"));}
...
if (globalTrace)
    {printf("closeBrace at q/base.qon:469\n");}
  if (globalStepTrace) {console.log(new Error("StepTrace \n"));}
...
if (globalTrace)
    {printf("skipList at q/base.qon:473\n");}
  if (globalStepTrace) {console.log(new Error("StepTrace \n"));}
...
if (globalTrace)
    {printf("makeNode at q/base.qon:497\n");}
  if (globalStepTrace) {console.log(new Error("StepTrace \n"));}
...
if (globalTrace)
    {printf("addToNode at q/base.qon:513\n");}
  if (globalStepTrace) {console.log(new Error("StepTrace \n"));}
...
if (globalTrace)
    {printf("makeStatementNode at q/base.qon:518\n");}
  if (globalStepTrace) {console.log(new Error("StepTrace \n"));}
...
if (globalTrace)
    {printf("astExpression at q/base.qon:523\n");}
  if (globalStepTrace) {console.log(new Error("StepTrace \n"));}
...
if (globalTrace)
    {printf("astSubExpression at q/base.qon:531\n");}
  if (globalStepTrace) {console.log(new Error("StepTrace \n"));}
...
if (globalTrace)
    {printf("astIf at q/base.qon:542\n");}
  if (globalStepTrace) {console.log(new Error("StepTrace \n"));}
...
if (globalTrace)
    {printf("astSetStruct at q/base.qon:563\n");}
  if (globalStepTrace) {console.log(new Error("StepTrace \n"));}
...
if (globalTrace)
    {printf("astSet at q/base.qon:568\n");}
  if (globalStepTrace) {console.log(new Error("StepTrace \n"));}
...
if (globalTrace)
    {printf("astGetStruct at q/base.qon:573\n");}
  if (globalStepTrace) {console.log(new Error("StepTrace \n"));}
...
if (globalTrace)
    {printf("astReturnVoid at q/base.qon:576\n");}
  if (globalStepTrace) {console.log(new Error("StepTrace \n"));}
...
if (globalTrace)
    {printf("astStatement at q/base.qon:580\n");}
  if (globalStepTrace) {console.log(new Error("StepTrace \n"));}
...
if (globalTrace)
    {printf("astBody at q/base.qon:618\n");}
  if (globalStepTrace) {console.log(new Error("StepTrace \n"));}
...
if (globalTrace)
    {printf("locPanic at q/base.qon:624\n");}
  if (globalStepTrace) {console.log(new Error("StepTrace \n"));}
...
if (globalTrace)
    {printf("astFunction at q/base.qon:630\n");}
  if (globalStepTrace) {console.log(new Error("StepTrace \n"));}
...
if (globalTrace)
    {printf("astFunctionList at q/base.qon:665\n");}
  if (globalStepTrace) {console.log(new Error("StepTrace \n"));}
...
if (globalTrace)
    {printf("astFunctions at q/base.qon:673\n");}
  if (globalStepTrace) {console.log(new Error("StepTrace \n"));}
...
if (globalTrace)
    {printf("loadLib at q/base.qon:681\n");}
  if (globalStepTrace) {console.log(new Error("StepTrace \n"));}
...
if (globalTrace)
    {printf("astInclude at q/base.qon:697\n");}
  if (globalStepTrace) {console.log(new Error("StepTrace \n"));}
...
if (globalTrace)
    {printf("astIncludeList at q/base.qon:700\n");}
  if (globalStepTrace) {console.log(new Error("StepTrace \n"));}
...
if (globalTrace)
    {printf("astIncludes at q/base.qon:707\n");}
  if (globalStepTrace) {console.log(new Error("StepTrace \n"));}
...
if (globalTrace)
    {printf("astStruct at q/base.qon:716\n");}
  if (globalStepTrace) {console.log(new Error("StepTrace \n"));}
...
if (globalTrace)
    {printf("astType at q/base.qon:719\n");}
  if (globalStepTrace) {console.log(new Error("StepTrace \n"));}
...
if (globalTrace)
    {printf("astTypeList at q/base.qon:725\n");}
  if (globalStepTrace) {console.log(new Error("StepTrace \n"));}
...
if (globalTrace)
    {printf("astTypes at q/base.qon:731\n");}
  if (globalStepTrace) {console.log(new Error("StepTrace \n"));}
...
if (globalTrace)
    {printf("declarationsof at q/base.qon:749\n");}
  if (globalStepTrace) {console.log(new Error("StepTrace \n"));}
...
if (globalTrace)
    {printf("codeof at q/base.qon:752\n");}
  if (globalStepTrace) {console.log(new Error("StepTrace \n"));}
...
if (globalTrace)
    {printf("functionNameof at q/base.qon:755\n");}
  if (globalStepTrace) {console.log(new Error("StepTrace \n"));}
...
if (globalTrace)
    {printf("nodeof at q/base.qon:758\n");}
  if (globalStepTrace) {console.log(new Error("StepTrace \n"));}
...
if (globalTrace)
    {printf("lineof at q/base.qon:766\n");}
  if (globalStepTrace) {console.log(new Error("StepTrace \n"));}
...
if (globalTrace)
    {printf("subnameof at q/base.qon:771\n");}
  if (globalStepTrace) {console.log(new Error("StepTrace \n"));}
...
if (globalTrace)
    {printf("nameof at q/base.qon:774\n");}
  if (globalStepTrace) {console.log(new Error("StepTrace \n"));}
...
if (globalTrace)
    {printf("childrenof at q/base.qon:777\n");}
  if (globalStepTrace) {console.log(new Error("StepTrace \n"));}
...
if (globalTrace)
    {printf("isNode at q/base.qon:781\n");}
  if (globalStepTrace) {console.log(new Error("StepTrace \n"));}
...
if (globalTrace)
    {printf("truthy at q/base.qon:795\n");}
  if (globalStepTrace) {console.log(new Error("StepTrace \n"));}
...
if (globalTrace)
    {printf("isNotFalse at q/base.qon:799\n");}
  if (globalStepTrace) {console.log(new Error("StepTrace \n"));}
...
if (globalTrace)
    {printf("isLeaf at q/base.qon:805\n");}
  if (globalStepTrace) {console.log(new Error("StepTrace \n"));}
...
if (globalTrace)
    {printf("printIndent at q/base.qon:809\n");}
  if (globalStepTrace) {console.log(new Error("StepTrace \n"));}
...
if (globalTrace)
    {printf("newLine at q/base.qon:817\n");}
  if (globalStepTrace) {console.log(new Error("StepTrace \n"));}
...
if (globalTrace)
    {printf("noStackTrace at q/base.qon:821\n");}
  if (globalStepTrace) {console.log(new Error("StepTrace \n"));}
...
if (globalTrace)
    {printf("toStr at q/base.qon:850\n");}
  if (globalStepTrace) {console.log(new Error("StepTrace \n"));}
...
if (globalTrace)
    {printf("listLast at q/base.qon:853\n");}
  if (globalStepTrace) {console.log(new Error("StepTrace \n"));}
...
if (globalTrace)
    {printf("treeCompile at q/base.qon:860\n");}
  if (globalStepTrace) {console.log(new Error("StepTrace \n"));}
...
if (globalTrace)
    {printf("astBuild at q/base.qon:866\n");}
  if (globalStepTrace) {console.log(new Error("StepTrace \n"));}
...
if (globalTrace)
    {printf("astCompile at q/base.qon:883\n");}
  if (globalStepTrace) {console.log(new Error("StepTrace \n"));}
...
if (globalTrace)
    {printf("mergeIncludes at q/base.qon:910\n");}
  if (globalStepTrace) {console.log(new Error("StepTrace \n"));}
...
if (globalTrace)
    {printf("merge_recur at q/base.qon:917\n");}
  if (globalStepTrace) {console.log(new Error("StepTrace \n"));}
...
if (globalTrace)
    {printf("mergeInclude at q/base.qon:925\n");}
  if (globalStepTrace) {console.log(new Error("StepTrace \n"));}
...
if (globalTrace)
    {printf("argList at q/base.qon:986\n");}
  if (globalStepTrace) {console.log(new Error("StepTrace \n"));}
...
if (globalTrace)
    {printf("perlTypeDecl at q/perl.qon:305\n");}
...
if (globalTrace)
    {printf("perlStructComponents at q/perl.qon:310\n");}
  if (globalStepTrace) {console.log(new Error("StepTrace \n"));}
...
if (globalTrace)
    {printf("perlStruct at q/perl.qon:316\n");}
  if (globalStepTrace) {console.log(new Error("StepTrace \n"));}
...
if (globalTrace)
    {printf("perlTypeMap at q/perl.qon:319\n");}
  if (globalStepTrace) {console.log(new Error("StepTrace \n"));}
...
if (globalTrace)
    {printf("perlConstMap at q/perl.qon:331\n");}
  if (globalStepTrace) {console.log(new Error("StepTrace \n"));}
...
if (globalTrace)
    {printf("perlFuncMap at q/perl.qon:341\n");}
  if (globalStepTrace) {console.log(new Error("StepTrace \n"));}
...
if (globalTrace)
    {printf("perlType at q/perl.qon:358\n");}
...
if (globalTrace)
    {printf("perlTypes at q/perl.qon:363\n");}
  if (globalStepTrace) {console.log(new Error("StepTrace \n"));}
...
if (globalTrace)
    {printf("perlFunctionArgs at q/perl.qon:369\n");}
  if (globalStepTrace) {console.log(new Error("StepTrace \n"));}
...
if (globalTrace)
    {printf("perlCompile at q/perl.qon:379\n");}
  if (globalStepTrace) {console.log(new Error("StepTrace \n"));}
...
if (globalTrace)
    {printf("ansiTypeDecl at q/ansi.qon:240\n");}
  if (globalStepTrace) {console.log(new Error("StepTrace \n"));}
...
if (globalTrace)
    {printf("ansiStructComponents at q/ansi.qon:257\n");}
  if (globalStepTrace) {console.log(new Error("StepTrace \n"));}
...
if (globalTrace)
    {printf("ansiStruct at q/ansi.qon:263\n");}
  if (globalStepTrace) {console.log(new Error("StepTrace \n"));}
...
if (globalTrace)
    {printf("ansiTypeMap at q/ansi.qon:266\n");}
  if (globalStepTrace) {console.log(new Error("StepTrace \n"));}
...
if (globalTrace)
    {printf("ansiFuncMap at q/ansi.qon:278\n");}
  if (globalStepTrace) {console.log(new Error("StepTrace \n"));}
...
if (globalTrace)
    {printf("ansiType at q/ansi.qon:309\n");}
  if (globalStepTrace) {console.log(new Error("StepTrace \n"));}
...
if (globalTrace)
    {printf("ansiTypes at q/ansi.qon:319\n");}
  if (globalStepTrace) {console.log(new Error("StepTrace \n"));}
...
if (globalTrace)
    {printf("ansiCompile at q/ansi.qon:329\n");}
  if (globalStepTrace) {console.log(new Error("StepTrace \n"));}
...
if (globalTrace)
    {printf("ansi2TypeDecl at q/ansi2.qon:290\n");}
  if (globalStepTrace) {console.log(new Error("StepTrace \n"));}
...
if (globalTrace)
    {printf("ansi2StructComponents at q/ansi2.qon:307\n");}
  if (globalStepTrace) {console.log(new Error("StepTrace \n"));}
...
if (globalTrace)
    {printf("ansi2Struct at q/ansi2.qon:313\n");}
  if (globalStepTrace) {console.log(new Error("StepTrace \n"));}
...
if (globalTrace)
    {printf("ansi2TypeMap at q/ansi2.qon:316\n");}
  if (globalStepTrace) {console.log(new Error("StepTrace \n"));}
...
if (globalTrace)
    {printf("ansi2FuncMap at q/ansi2.qon:328\n");}
  if (globalStepTrace) {console.log(new Error("StepTrace \n"));}
...
if (globalTrace)
    {printf("ansi2Type at q/ansi2.qon:359\n");}
  if (globalStepTrace) {console.log(new Error("StepTrace \n"));}
...
if (globalTrace)
    {printf("ansi2Types at q/ansi2.qon:369\n");}
  if (globalStepTrace) {console.log(new Error("StepTrace \n"));}
...
if (globalTrace)
    {printf("ansi2Compile at q/ansi2.qon:379\n");}
  if (globalStepTrace) {console.log(new Error("StepTrace \n"));}
...
if (globalTrace)
    {printf("test4 at q/tests.qon:47\n");}
  if (globalStepTrace) {console.log(new Error("StepTrace \n"));}
...
if (globalTrace)
    {printf("test5 at q/tests.qon:52\n");}
  if (globalStepTrace) {console.log(new Error("StepTrace \n"));}
...
if (globalTrace)
    {printf("test6 at q/tests.qon:59\n");}
  if (globalStepTrace) {console.log(new Error("StepTrace \n"));}
...
if (globalTrace)
    {printf("test7_do at q/tests.qon:67\n");}
  if (globalStepTrace) {console.log(new Error("StepTrace \n"));}
...
if (globalTrace)
    {printf("test7 at q/tests.qon:75\n");}
  if (globalStepTrace) {console.log(new Error("StepTrace \n"));}
...
if (globalTrace)
    {printf("plural at q/tests.qon:92\n");}
  if (globalStepTrace) {console.log(new Error("StepTrace \n"));}
...
if (globalTrace)
    {printf("beers at q/tests.qon:97\n");}
  if (globalStepTrace) {console.log(new Error("StepTrace \n"));}
...
if (globalTrace)
    {printf("test8 at q/tests.qon:113\n");}
  if (globalStepTrace) {console.log(new Error("StepTrace \n"));}
...
if (globalTrace)
    {printf("test9 at q/tests.qon:121\n");}
  if (globalStepTrace) {console.log(new Error("StepTrace \n"));}
...
if (globalTrace)
    {printf("test10 at q/tests.qon:130\n");}
  if (globalStepTrace) {console.log(new Error("StepTrace \n"));}
...
if (globalTrace)
    {printf("test12 at q/tests.qon:140\n");}
  if (globalStepTrace) {console.log(new Error("StepTrace \n"));}
...
if (globalTrace)
    {printf("test13 at q/tests.qon:148\n");}
  if (globalStepTrace) {console.log(new Error("StepTrace \n"));}
...
if (globalTrace)
    {printf("test15 at q/tests.qon:164\n");}
  if (globalStepTrace) {console.log(new Error("StepTrace \n"));}
...
if (globalTrace)
    {printf("test16 at q/tests.qon:172\n");}
  if (globalStepTrace) {console.log(new Error("StepTrace \n"));}
...
if (globalTrace)
    {printf("test17 at q/tests.qon:196\n");}
  if (globalStepTrace) {console.log(new Error("StepTrace \n"));}
...
if (globalTrace)
    {printf("test18 at q/tests.qon:207\n");}
  if (globalStepTrace) {console.log(new Error("StepTrace \n"));}
...
if (globalTrace)
    {printf("test19 at q/tests.qon:221\n");}
  if (globalStepTrace) {console.log(new Error("StepTrace \n"));}
...
if (globalTrace)
    {printf("concatenateLists at q/tests.qon:239\n");}
  if (globalStepTrace) {console.log(new Error("StepTrace \n"));}
...
if (globalTrace)
    {printf("test20 at q/tests.qon:244\n");}
  if (globalStepTrace) {console.log(new Error("StepTrace \n"));}
...
if (globalTrace)
    {printf("test22 at q/tests.qon:280\n");}
  if (globalStepTrace) {console.log(new Error("StepTrace \n"));}
...
if (globalTrace)
    {printf("test23 at q/tests.qon:303\n");}
  if (globalStepTrace) {console.log(new Error("StepTrace \n"));}
...
if (globalTrace)
    {printf("javaTypes at q/java.qon:334\n");}
  if (globalStepTrace) {console.log(new Error("StepTrace \n"));}
...
if (globalTrace)
    {printf("javaCompile at q/java.qon:340\n");}
  if (globalStepTrace) {console.log(new Error("StepTrace \n"));}
