...
if (globalTrace)
    {printf("ternString at q/base.qon:41\n");}
  if (globalStepTrace) {console.log(new Error("StepTrace \n"));}
...
if (globalTrace)
    {printf("ternList at q/base.qon:45\n");}
  if (globalStepTrace) {console.log(new Error("StepTrace \n"));}
...
if (globalTrace)
    {printf("newVoid at q/base.qon:50\n");}
  if (globalStepTrace) {console.log(new Error("StepTrace \n"));}
...
if (globalTrace)
    {printf("stackDump at q/base.qon:59\n");}
  if (globalStepTrace) {console.log(new Error("StepTrace \n"));}
...
if (globalTrace)
    {printf("boxType at q/base.qon:94\n");}
  if (globalStepTrace) {console.log(new Error("StepTrace \n"));}
...
if (globalTrace)
    {printf("makeBox at q/base.qon:98\n");}
  if (globalStepTrace) {console.log(new Error("StepTrace \n"));}
...
if (globalTrace)
    {printf("makePair at q/base.qon:112\n");}
  if (globalStepTrace) {console.log(new Error("StepTrace \n"));}
...
if (globalTrace)
    {printf("unBoxString at q/base.qon:169\n");}
  if (globalStepTrace) {console.log(new Error("StepTrace \n"));}
...
if (globalTrace)
    {printf("unBoxSymbol at q/base.qon:172\n");}
  if (globalStepTrace) {console.log(new Error("StepTrace \n"));}
...
if (globalTrace)
    {printf("unBoxBool at q/base.qon:173\n");}
  if (globalStepTrace) {console.log(new Error("StepTrace \n"));}
...
if (globalTrace)
    {printf("unBoxInt at q/base.qon:174\n");}
  if (globalStepTrace) {console.log(new Error("StepTrace \n"));}
...
if (globalTrace)
    {printf("stringify_rec at q/base.qon:176\n");}
  if (globalStepTrace) {console.log(new Error("StepTrace \n"));}
...
if (globalTrace)
    {printf("assocExists at q/base.qon:249\n");}
  if (globalStepTrace) {console.log(new Error("StepTrace \n"));}
...
if (globalTrace)
    {printf("assocFail at q/base.qon:257\n");}
  if (globalStepTrace) {console.log(new Error("StepTrace \n"));}
...
if (globalTrace)
    {printf("assocPanic at q/base.qon:264\n");}
  if (globalStepTrace) {console.log(new Error("StepTrace \n"));}
...
if (globalTrace)
    {printf("locPanic at q/base.qon:281\n");}
  if (globalStepTrace) {console.log(new Error("StepTrace \n"));}
...
if (globalTrace)
    {printf("truthy at q/base.qon:287\n");}
  if (globalStepTrace) {console.log(new Error("StepTrace \n"));}
...
if (globalTrace)
    {printf("isNotFalse at q/base.qon:292\n");}
  if (globalStepTrace) {console.log(new Error("StepTrace \n"));}
...
if (globalTrace)
    {printf("toStr at q/base.qon:299\n");}
  if (globalStepTrace) {console.log(new Error("StepTrace \n"));}
...
if (globalTrace)
    {printf("listLast at q/base.qon:303\n");}
  if (globalStepTrace) {console.log(new Error("StepTrace \n"));}
...
if (globalTrace)
    {printf("newLine at q/base.qon:310\n");}
  if (globalStepTrace) {console.log(new Error("StepTrace \n"));}
...
if (globalTrace)
    {printf("printIndent at q/base.qon:314\n");}
  if (globalStepTrace) {console.log(new Error("StepTrace \n"));}
...
if (globalTrace)
    {printf("stringIndent at q/base.qon:321\n");}
  if (globalStepTrace) {console.log(new Error("StepTrace \n"));}
...
if (globalTrace)
    {printf("argList at q/base.qon:329\n");}
  if (globalStepTrace) {console.log(new Error("StepTrace \n"));}
...
if (globalTrace)
    {printf("troff at q/base.qon:340\n");}
  if (globalStepTrace) {console.log(new Error("StepTrace \n"));}
...
if (globalTrace)
    {printf("stron at q/base.qon:341\n");}
  if (globalStepTrace) {console.log(new Error("StepTrace \n"));}
...
if (globalTrace)
    {printf("stroff at q/base.qon:342\n");}
  if (globalStepTrace) {console.log(new Error("StepTrace \n"));}
...
if (globalTrace)
    {printf("StackTraceMove at q/base.qon:346\n");}
  if (globalStepTrace) {console.log(new Error("StepTrace \n"));}

  if ( equalString(direction, "in")) {    if (globalStepTrace) {console.log(new Error("StepTrace \n"));}
...
if (globalTrace)
    {printf("StackTracePrint at q/base.qon:354\n");}
  if (globalStepTrace) {console.log(new Error("StepTrace \n"));}

  printf("Stack trace:\n");
  if (globalStepTrace) {console.log(new Error("StepTrace \n"));}

  if ( isNil(globalStackTrace)) {    if (globalStepTrace) {console.log(new Error("StepTrace \n"));}
...
if (globalTrace)
    {printf("StackTracePrintHelper at q/base.qon:362\n");}
  if (globalStepTrace) {console.log(new Error("StepTrace \n"));}

  if ( isNil(stack)) {    if (globalStepTrace) {console.log(new Error("StepTrace \n"));}
...
if (globalTrace)
    {printf("NoStackTrace_list at q/base.qon:385\n");}
  if (globalStepTrace) {console.log(new Error("StepTrace \n"));}
...
if (globalTrace)
    {printf("NoTrace_list at q/base.qon:390\n");}
  if (globalStepTrace) {console.log(new Error("StepTrace \n"));}
...
if (globalTrace)
  ...
  if ( greaterthan(add(start, len), string_length(prog))) {    if (globalStepTrace) {console.log(new Error("StepTrace \n"));}
...
if (globalTrace)
    {printf("isOpenBrace at q/compiler.qon:175\n");}
  if (globalStepTrace) {console.log(new Error("StepTrace \n"));}
...
if (globalTrace)
    {printf("isCloseBrace at q/compiler.qon:184\n");}
  if (globalStepTrace) {console.log(new Error("StepTrace \n"));}
...
if (globalTrace)
    {printf("skipList at q/compiler.qon:197\n");}
  if (globalStepTrace) {console.log(new Error("StepTrace \n"));}
...
if (globalTrace)
    {printf("makeNode at q/compiler.qon:219\n");}
  if (globalStepTrace) {console.log(new Error("StepTrace \n"));}
...
if (globalTrace)
    {printf("addToNode at q/compiler.qon:235\n");}
  if (globalStepTrace) {console.log(new Error("StepTrace \n"));}
...
if (globalTrace)
    {printf("makeStatementNode at q/compiler.qon:240\n");}
  if (globalStepTrace) {console.log(new Error("StepTrace \n"));}
...
if (globalTrace)
    {printf("astExpression at q/compiler.qon:245\n");}
  if (globalStepTrace) {console.log(new Error("StepTrace \n"));}
...
if (globalTrace)
    {printf("astSubExpression at q/compiler.qon:253\n");}
  if (globalStepTrace) {console.log(new Error("StepTrace \n"));}
...
if (globalTrace)
    {printf("astIf at q/compiler.qon:264\n");}
  if (globalStepTrace) {console.log(new Error("StepTrace \n"));}
...
if (globalTrace)
    {printf("astSetStruct at q/compiler.qon:285\n");}
  if (globalStepTrace) {console.log(new Error("StepTrace \n"));}
...
if (globalTrace)
    {printf("astSet at q/compiler.qon:290\n");}
  if (globalStepTrace) {console.log(new Error("StepTrace \n"));}
...
if (globalTrace)
    {printf("astGetStruct at q/compiler.qon:295\n");}
  if (globalStepTrace) {console.log(new Error("StepTrace \n"));}
...
if (globalTrace)
    {printf("astReturnVoid at q/compiler.qon:298\n");}
  if (globalStepTrace) {console.log(new Error("StepTrace \n"));}
...
if (globalTrace)
    {printf("astStatement at q/compiler.qon:302\n");}
  if (globalStepTrace) {console.log(new Error("StepTrace \n"));}
...
if (globalTrace)
    {printf("astBody at q/compiler.qon:340\n");}
  if (globalStepTrace) {console.log(new Error("StepTrace \n"));}
...
if (globalTrace)
    {printf("astFunction at q/compiler.qon:348\n");}
  if (globalStepTrace) {console.log(new Error("StepTrace \n"));}
...
if (globalTrace)
    {printf("astFunctionList at q/compiler.qon:381\n");}
  if (globalStepTrace) {console.log(new Error("StepTrace \n"));}
...
if (globalTrace)
    {printf("astFunctions at q/compiler.qon:389\n");}
  if (globalStepTrace) {console.log(new Error("StepTrace \n"));}
...
if (globalTrace)
    {printf("loadLib at q/compiler.qon:397\n");}
  if (globalStepTrace) {console.log(new Error("StepTrace \n"));}
...
if (globalTrace)
    {printf("astInclude at q/compiler.qon:413\n");}
  if (globalStepTrace) {console.log(new Error("StepTrace \n"));}
...
if (globalTrace)
    {printf("astIncludeList at q/compiler.qon:416\n");}
  if (globalStepTrace) {console.log(new Error("StepTrace \n"));}
...
if (globalTrace)
    {printf("astIncludes at q/compiler.qon:423\n");}
  if (globalStepTrace) {console.log(new Error("StepTrace \n"));}
...
if (globalTrace)
    {printf("astStruct at q/compiler.qon:431\n");}
  if (globalStepTrace) {console.log(new Error("StepTrace \n"));}
...
if (globalTrace)
    {printf("astType at q/compiler.qon:434\n");}
  if (globalStepTrace) {console.log(new Error("StepTrace \n"));}
...
if (globalTrace)
    {printf("astTypeList at q/compiler.qon:440\n");}
  if (globalStepTrace) {console.log(new Error("StepTrace \n"));}
...
if (globalTrace)
    {printf("astTypes at q/compiler.qon:446\n");}
  if (globalStepTrace) {console.log(new Error("StepTrace \n"));}
...
if (globalTrace)
    {printf("declarationsof at q/compiler.qon:464\n");}
  if (globalStepTrace) {console.log(new Error("StepTrace \n"));}
...
if (globalTrace)
    {printf("codeof at q/compiler.qon:467\n");}
  if (globalStepTrace) {console.log(new Error("StepTrace \n"));}
...
if (globalTrace)
    {printf("functionNameof at q/compiler.qon:470\n");}
  if (globalStepTrace) {console.log(new Error("StepTrace \n"));}
...
if (globalTrace)
    {printf("nodeof at q/compiler.qon:473\n");}
  if (globalStepTrace) {console.log(new Error("StepTrace \n"));}
...
if (globalTrace)
    {printf("lineof at q/compiler.qon:481\n");}
  if (globalStepTrace) {console.log(new Error("StepTrace \n"));}
...
if (globalTrace)
    {printf("subnameof at q/compiler.qon:486\n");}
  if (globalStepTrace) {console.log(new Error("StepTrace \n"));}
...
if (globalTrace)
    {printf("nameof at q/compiler.qon:489\n");}
  if (globalStepTrace) {console.log(new Error("StepTrace \n"));}
...
if (globalTrace)
    {printf("childrenof at q/compiler.qon:492\n");}
  if (globalStepTrace) {console.log(new Error("StepTrace \n"));}
...
if (globalTrace)
    {printf("isNode at q/compiler.qon:496\n");}
  if (globalStepTrace) {console.log(new Error("StepTrace \n"));}
...
if (globalTrace)
    {printf("isLeaf at q/compiler.qon:512\n");}
  if (globalStepTrace) {console.log(new Error("StepTrace \n"));}
...
if (globalTrace)
    {printf("noStackTrace at q/compiler.qon:515\n");}
  if (globalStepTrace) {console.log(new Error("StepTrace \n"));}
...
if (globalTrace)
    {printf("treeCompile at q/compiler.qon:547\n");}
  if (globalStepTrace) {console.log(new Error("StepTrace \n"));}
...
if (globalTrace)
    {printf("astBuild at q/compiler.qon:553\n");}
  if (globalStepTrace) {console.log(new Error("StepTrace \n"));}
...
if (globalTrace)
    {printf("astCompile at q/compiler.qon:570\n");}
  if (globalStepTrace) {console.log(new Error("StepTrace \n"));}
...
if (globalTrace)
    {printf("mergeIncludes at q/compiler.qon:594\n");}
  if (globalStepTrace) {console.log(new Error("StepTrace \n"));}
...
if (globalTrace)
    {printf("merge_recur at q/compiler.qon:601\n");}
  if (globalStepTrace) {console.log(new Error("StepTrace \n"));}
...
if (globalTrace)
    {printf("mergeInclude at q/compiler.qon:609\n");}
  if (globalStepTrace) {console.log(new Error("StepTrace \n"));}
...
if (globalTrace)
    {printf("macrosingle at q/macros.qon:56\n");}
  if (globalStepTrace) {console.log(new Error("StepTrace \n"));}
  ...
  if ( isEmpty(tree)) {    if (globalStepTrace) {console.log(new Error("StepTrace \n"));}
    ...
    if ( isList(tree)) {      if (globalStepTrace) {console.log(new Error("StepTrace \n"));}
      ...
      if ( equalString(search, stringify(tree))) {        if (globalStepTrace) {console.log(new Error("StepTrace \n"));}
...
if (globalTrace)
    {printf("macrolist at q/macros.qon:83\n");}
  if (globalStepTrace) {console.log(new Error("StepTrace \n"));}
...
if (globalTrace)
    {printf("doMultiList at q/lists.qon:146\n");}
  if (globalStepTrace) {console.log(new Error("StepTrace \n"));}
...
function isInt(val) {
  var firstLetter = [sub-string val 0 1];

if (globalTrace)
    {printf("isInt at q/lists.qon:168\n");}
  if (globalStepTrace) {console.log(new Error("StepTrace \n"));}

  if ( equalString("-", firstLetter)) {    if (globalStepTrace) {console.log(new Error("StepTrace \n"));}

    return(true);

  } else {    if (globalStepTrace) {console.log(new Error("StepTrace \n"));}

    if ( equalString("0", firstLetter)) {      if (globalStepTrace) {console.log(new Error("StepTrace \n"));}

      return(true);

    } else {      if (globalStepTrace) {console.log(new Error("StepTrace \n"));}

      if ( equalString("1", firstLetter)) {        if (globalStepTrace) {console.log(new Error("StepTrace \n"));}

        return(true);

      } else {        if (globalStepTrace) {console.log(new Error("StepTrace \n"));}

        if ( equalString("2", firstLetter)) {          if (globalStepTrace) {console.log(new Error("StepTrace \n"));}

          return(true);

        } else {          if (globalStepTrace) {console.log(new Error("StepTrace \n"));}

          if ( equalString("3", firstLetter)) {            if (globalStepTrace) {console.log(new Error("StepTrace \n"));}

            return(true);

          } else {            if (globalStepTrace) {console.log(new Error("StepTrace \n"));}

            if ( equalString("4", firstLetter)) {              if (globalStepTrace) {console.log(new Error("StepTrace \n"));}

              return(true);

            } else {              if (globalStepTrace) {console.log(new Error("StepTrace \n"));}

              if ( equalString("5", firstLetter)) {                if (globalStepTrace) {console.log(new Error("StepTrace \n"));}

                return(true);

              } else {                if (globalStepTrace) {console.log(new Error("StepTrace \n"));}

                if ( equalString("6", firstLetter)) {                  if (globalStepTrace) {console.log(new Error("StepTrace \n"));}

                  return(true);

                } else {                  if (globalStepTrace) {console.log(new Error("StepTrace \n"));}

                  if ( equalString("7", firstLetter)) {                    if (globalStepTrace) {console.log(new Error("StepTrace \n"));}

                    return(true);

                  } else {                    if (globalStepTrace) {console.log(new Error("StepTrace \n"));}

                    if ( equalString("8", firstLetter)) {                      if (globalStepTrace) {console.log(new Error("StepTrace \n"));}

                      return(true);

                    } else {                      if (globalStepTrace) {console.log(new Error("StepTrace \n"));}

                      if ( equalString("9", firstLetter)) {                        if (globalStepTrace) {console.log(new Error("StepTrace \n"));}
...
if (globalTrace)
    {printf("chooseBoxInterp at q/lists.qon:199\n");}
  if (globalStepTrace) {console.log(new Error("StepTrace \n"));}
  ...
  if ( equalString("string", boxType(b))) {    if (globalStepTrace) {console.log(new Error("StepTrace \n"));}
    ...
    if ( equalString("\"", firstLetter)) {      if (globalStepTrace) {console.log(new Error("StepTrace \n"));}
      ...
      if ( equalString("true", val)) {        if (globalStepTrace) {console.log(new Error("StepTrace \n"));}

        return("boxBool");

      } else {        if (globalStepTrace) {console.log(new Error("StepTrace \n"));}

        if ( equalString("false", val)) {          if (globalStepTrace) {console.log(new Error("StepTrace \n"));}

          return("boxBool");

        } else {          if (globalStepTrace) {console.log(new Error("StepTrace \n"));}

          if ( isInt(val)) {            if (globalStepTrace) {console.log(new Error("StepTrace \n"));}
...
if (globalTrace)
    {printf("doInterpolatedList at q/lists.qon:224\n");}
  if (globalStepTrace) {console.log(new Error("StepTrace \n"));}
...
if (globalTrace)
    {printf("doStringList at q/lists.qon:248\n");}
  if (globalStepTrace) {console.log(new Error("StepTrace \n"));}
...
if (globalTrace)
    {printf("doSymbolList at q/lists.qon:265\n");}
  if (globalStepTrace) {console.log(new Error("StepTrace \n"));}
...
if (globalTrace)
    {printf("doBoxList at q/lists.qon:283\n");}
  if (globalStepTrace) {console.log(new Error("StepTrace \n"));}
...
if (globalTrace)
    {printf("concatLists at q/lists.qon:302\n");}
  if (globalStepTrace) {console.log(new Error("StepTrace \n"));}
...
if (globalTrace)
    {printf("alistKeys at q/lists.qon:308\n");}
  if (globalStepTrace) {console.log(new Error("StepTrace \n"));}
...
if (globalTrace)
    {printf("display at q/lists.qon:314\n");}
  if (globalStepTrace) {console.log(new Error("StepTrace \n"));}
...
if (globalTrace)
    {printf("displayList at q/lists.qon:323\n");}
  if (globalStepTrace) {console.log(new Error("StepTrace \n"));}
...
if (globalTrace)
    {printf("StringListJoinRec at q/lists.qon:354\n");}
  if (globalStepTrace) {console.log(new Error("StepTrace \n"));}
  ...
  if ( isEmpty(l)) {    if (globalStepTrace) {console.log(new Error("StepTrace \n"));}
    ...
    if ( isList(l)) {      if (globalStepTrace) {console.log(new Error("StepTrace \n"));}
      ...
      if ( isEmpty(l)) {        if (globalStepTrace) {console.log(new Error("StepTrace \n"));}
        ...
        if ( equal(listLength(l), 1)) {          if (globalStepTrace) {console.log(new Error("StepTrace \n"));}
...
if (globalTrace)
    {printf("StringListJoin at q/lists.qon:377\n");}
  if (globalStepTrace) {console.log(new Error("StepTrace \n"));}
...
if (globalTrace)
    {printf("ListToBoxString at q/lists.qon:387\n");}
  if (globalStepTrace) {console.log(new Error("StepTrace \n"));}
...
if (globalTrace)
    {printf("ListToString at q/lists.qon:392\n");}
  if (globalStepTrace) {console.log(new Error("StepTrace \n"));}
...
if (globalTrace)
    {printf("listReverse at q/lists.qon:432\n");}
  if (globalStepTrace) {console.log(new Error("StepTrace \n"));}
...
if (globalTrace)
    {printf("inList at q/lists.qon:438\n");}
  if (globalStepTrace) {console.log(new Error("StepTrace \n"));}
...
if (globalTrace)
    {printf("equalList at q/lists.qon:448\n");}
  if (globalStepTrace) {console.log(new Error("StepTrace \n"));}
...
if (globalTrace)
    {printf("reverseRec at q/lists.qon:471\n");}
  if (globalStepTrace) {console.log(new Error("StepTrace \n"));}
...
if (globalTrace)
    {printf("reverseList at q/lists.qon:478\n");}
  if (globalStepTrace) {console.log(new Error("StepTrace \n"));}
...
if (globalTrace)
    {printf("flatten at q/lists.qon:483\n");}
  if (globalStepTrace) {console.log(new Error("StepTrace \n"));}
  ...
  if ( isEmpty(tree)) {    if (globalStepTrace) {console.log(new Error("StepTrace \n"));}
    ...
    if ( isList(car(tree))) {      if (globalStepTrace) {console.log(new Error("StepTrace \n"));}
...
if (globalTrace)
    {printf("ansi3RecurList at q/ansi3.qon:99\n");}
  if (globalStepTrace) {console.log(new Error("StepTrace \n"));}
...
if (globalTrace)
    {printf("ansi3If at q/ansi3.qon:116\n");}
  if (globalStepTrace) {console.log(new Error("StepTrace \n"));}
...
if (globalTrace)
    {printf("ansi3SetStruct at q/ansi3.qon:129\n");}
  if (globalStepTrace) {console.log(new Error("StepTrace \n"));}
...
if (globalTrace)
    {printf("ansi3GetStruct at q/ansi3.qon:138\n");}
  if (globalStepTrace) {console.log(new Error("StepTrace \n"));}
...
if (globalTrace)
    {printf("ansi3Set at q/ansi3.qon:146\n");}
  if (globalStepTrace) {console.log(new Error("StepTrace \n"));}
...
if (globalTrace)
    {printf("ansi3Return at q/ansi3.qon:153\n");}
  if (globalStepTrace) {console.log(new Error("StepTrace \n"));}
...
if (globalTrace)
    {printf("ansi3Statement at q/ansi3.qon:167\n");}
  if (globalStepTrace) {console.log(new Error("StepTrace \n"));}
...
if (globalTrace)
    {printf("ansi3Body at q/ansi3.qon:190\n");}
  if (globalStepTrace) {console.log(new Error("StepTrace \n"));}
  ...
  if ( isEmpty(tree)) {    if (globalStepTrace) {console.log(new Error("StepTrace \n"));}
    ...
    if ( isNil(code)) {
      ...
      if ( not(releaseMode)) {        if (globalStepTrace) {console.log(new Error("StepTrace \n"));}
        ...
        if ( inList(boxString(functionName), NoTrace_list())) {          if (globalStepTrace) {console.log(new Error("StepTrace \n"));}
...
//Building function ansi3Declarations from line: 219

function ansi3Declarations(decls,indent) {
  var decl = NULL;

if (globalTrace)
    {printf("ansi3Declarations at q/ansi3.qon:219\n");}
  if (globalStepTrace) {console.log(new Error("StepTrace \n"));}
...
//Building function ansi3Function from line: 233

function ansi3Function(node) {
  var name = NULL;

if (globalTrace)
    {printf("ansi3Function at q/ansi3.qon:233\n");}
  if (globalStepTrace) {console.log(new Error("StepTrace \n"));}
  ...
  if ( isNil(node)) {    if (globalStepTrace) {console.log(new Error("StepTrace \n"));}
    ...
    if ( releaseMode) {      if (globalStepTrace) {console.log(new Error("StepTrace \n"));}
      ...
      if ( inList(name, NoTrace_list())) {        if (globalStepTrace) {console.log(new Error("StepTrace \n"));}
...
if (globalTrace)
    {printf("ansi3ForwardDeclaration at q/ansi3.qon:272\n");}
  if (globalStepTrace) {console.log(new Error("StepTrace \n"));}
...
if (globalTrace)
    {printf("ansi3ForwardDeclarations at q/ansi3.qon:282\n");}
  if (globalStepTrace) {console.log(new Error("StepTrace \n"));}
...
if (globalTrace)
    {printf("ansi3Functions at q/ansi3.qon:288\n");}
  if (globalStepTrace) {console.log(new Error("StepTrace \n"));}
...
if (globalTrace)
    {printf("ansi3Includes at q/ansi3.qon:294\n");}
  if (globalStepTrace) {console.log(new Error("StepTrace \n"));}
...
if (globalTrace)
    {printf("ansi3TypeDecl at q/ansi3.qon:302\n");}
  if (globalStepTrace) {console.log(new Error("StepTrace \n"));}
...
if (globalTrace)
    {printf("ansi3StructComponents at q/ansi3.qon:319\n");}
  if (globalStepTrace) {console.log(new Error("StepTrace \n"));}
...
if (globalTrace)
    {printf("ansi3Struct at q/ansi3.qon:325\n");}
  if (globalStepTrace) {console.log(new Error("StepTrace \n"));}
...
if (globalTrace)
    {printf("ansi3TypeMap at q/ansi3.qon:328\n");}
  if (globalStepTrace) {console.log(new Error("StepTrace \n"));}
...
if (globalTrace)
    {printf("ansi3FuncMap at q/ansi3.qon:338\n");}
  if (globalStepTrace) {console.log(new Error("StepTrace \n"));}
...
if (globalTrace)
    {printf("ansi3Type at q/ansi3.qon:369\n");}
  if (globalStepTrace) {console.log(new Error("StepTrace \n"));}
...
if (globalTrace)
    {printf("ansi3Types at q/ansi3.qon:379\n");}
  if (globalStepTrace) {console.log(new Error("StepTrace \n"));}
...
if (globalTrace)
    {printf("ansi3Compile at q/ansi3.qon:389\n");}
  if (globalStepTrace) {console.log(new Error("StepTrace \n"));}
...
if (globalTrace)
    {printf("test24 at q/tests.qon:366\n");}
  if (globalStepTrace) {console.log(new Error("StepTrace \n"));}
...
if (globalTrace)
    {printf("node2Includes at q/node2.qon:35\n");}
  if (globalStepTrace) {console.log(new Error("StepTrace \n"));}
...
if (globalTrace)
    {printf("start at compiler.qon:5\n");}
  if (globalStepTrace) {console.log(new Error("StepTrace \n"));}
