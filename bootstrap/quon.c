...
if (globalTrace)
    printf("Leaving node2Declarations\n");
...
//Building function ansi3RecurList from file q/ansi3.qon, line: 99
...
//Building function ansi3If from file q/ansi3.qon, line: 116
...
//Building function ansi3SetStruct from file q/ansi3.qon, line: 129
...
//Building function ansi3GetStruct from file q/ansi3.qon, line: 138
...
//Building function ansi3Set from file q/ansi3.qon, line: 146
...
//Building function ansi3Return from file q/ansi3.qon, line: 153
...
//Building function ansi3Statement from file q/ansi3.qon, line: 167
...
//Building function ansi3Body from file q/ansi3.qon, line: 190
...
//Building function ansi3Declarations from file q/ansi3.qon, line: 216
...
//Building function ansi3Function from file q/ansi3.qon, line: 230
...
//Building function ansi3ForwardDeclaration from file q/ansi3.qon, line: 264

void ansi3ForwardDeclaration(list node) {
  
if (globalTrace)
    printf("ansi3ForwardDeclaration at q/ansi3.qon:264 (%s)\n", caller);
...
if (globalTrace)
    snprintf(caller, 1024, "from q/ansi3.qon:272");
    if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);
...
//Building function ansi3ForwardDeclarations from file q/ansi3.qon, line: 274

void ansi3ForwardDeclarations(list tree) {
  
if (globalTrace)
    printf("ansi3ForwardDeclarations at q/ansi3.qon:274 (%s)\n", caller);
...
//Building function ansi3Functions from file q/ansi3.qon, line: 280

void ansi3Functions(list tree) {
  
if (globalTrace)
    printf("ansi3Functions at q/ansi3.qon:280 (%s)\n", caller);
...
//Building function ansi3Includes from file q/ansi3.qon, line: 286

void ansi3Includes(list nodes) {
  
if (globalTrace)
    printf("ansi3Includes at q/ansi3.qon:286 (%s)\n", caller);
...
//Building function ansi3TypeDecl from file q/ansi3.qon, line: 294

void ansi3TypeDecl(list l) {
  
if (globalTrace)
    printf("ansi3TypeDecl at q/ansi3.qon:294 (%s)\n", caller);
...
//Building function ansi3StructComponents from file q/ansi3.qon, line: 311

void ansi3StructComponents(list node) {
  
if (globalTrace)
    printf("ansi3StructComponents at q/ansi3.qon:311 (%s)\n", caller);
...
//Building function ansi3Struct from file q/ansi3.qon, line: 317

void ansi3Struct(list node) {
  
if (globalTrace)
    printf("ansi3Struct at q/ansi3.qon:317 (%s)\n", caller);
...
//Building function ansi3TypeMap from file q/ansi3.qon, line: 320

box ansi3TypeMap(box aSym) {
  list symMap = NULL;

if (globalTrace)
    printf("ansi3TypeMap at q/ansi3.qon:320 (%s)\n", caller);
...
if (globalTrace)
    snprintf(caller, 1024, "from q/ansi3.qon:328");
    if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);
...
//Building function ansi3FuncMap from file q/ansi3.qon, line: 330

box ansi3FuncMap(box aSym) {
  list symMap = NULL;

if (globalTrace)
    printf("ansi3FuncMap at q/ansi3.qon:330 (%s)\n", caller);

if (globalTrace)
    snprintf(caller, 1024, "from q/ansi3.qon:332");
  if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);
...
//Building function ansi3Type from file q/ansi3.qon, line: 361

void ansi3Type(list node) {
  
if (globalTrace)
    printf("ansi3Type at q/ansi3.qon:361 (%s)\n", caller);
...
//Building function ansi3Types from file q/ansi3.qon, line: 371

void ansi3Types(list nodes) {
  
if (globalTrace)
    printf("ansi3Types at q/ansi3.qon:371 (%s)\n", caller);
...
//Building function ansi3Compile from file q/ansi3.qon, line: 381
...
if (globalTrace)
    printf("ansi3Compile at q/ansi3.qon:381 (%s)\n", caller);
...
if (globalTrace)
    snprintf(caller, 1024, "from q/ansi3.qon:392");
  if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);
...
if (globalTrace)
    snprintf(caller, 1024, "from q/ansi3.qon:394");
  if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);
...
if (globalTrace)
    snprintf(caller, 1024, "from q/ansi3.qon:410");
  if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);
...
//Building function doMultiList from file q/lists.qon, line: 146
...
//Building function isInt from file q/lists.qon, line: 168
...
if (globalTrace)
    printf("Leaving isInt\n");

}


//Building function id from file q/lists.qon, line: 196
...
//Building function chooseBoxInterp from file q/lists.qon, line: 199
...
if (globalTrace)
    printf("Leaving chooseBoxInterp\n");

}


//Building function doInterpolatedList from file q/lists.qon, line: 224
...
if (globalTrace)
    printf("Leaving doInterpolatedList\n");

}


//Building function doStringList from file q/lists.qon, line: 248
...
//Building function doSymbolList from file q/lists.qon, line: 265
...
//Building function doBoxList from file q/lists.qon, line: 283
...
//Building function concatLists from file q/lists.qon, line: 302
...
//Building function alistKeys from file q/lists.qon, line: 308
...
//Building function display from file q/lists.qon, line: 314

void display(list l) {
  
if (globalTrace)
    printf("display at q/lists.qon:314 (%s)\n", caller);

if (globalTrace)
    snprintf(caller, 1024, "from q/lists.qon:316");
  if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);

  if ( isEmpty(l)) {
if (globalTrace)
    snprintf(caller, 1024, "from q/lists.qon:317");
    if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);
...
//Building function displayList from file q/lists.qon, line: 323

void displayList(list l, int indent, bool first) {
  box val = NULL;

if (globalTrace)
    printf("displayList at q/lists.qon:323 (%s)\n", caller);

if (globalTrace)
    snprintf(caller, 1024, "from q/lists.qon:325");
  if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);

  if ( isEmpty(l)) {
if (globalTrace)
    snprintf(caller, 1024, "from q/lists.qon:326");
    if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);
...
if (globalTrace)
    snprintf(caller, 1024, "from q/lists.qon:330");
      ...
      if ( isEmpty(l)) {
if (globalTrace)
    snprintf(caller, 1024, "from q/lists.qon:331");
        if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);
...
if (globalTrace)
    snprintf(caller, 1024, "from q/lists.qon:333");
        if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);

        if ( first) {
        } else {
if (globalTrace)
    snprintf(caller, 1024, "from q/lists.qon:335");
          if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);
...
if (globalTrace)
    snprintf(caller, 1024, "from q/lists.qon:336");
        if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);

        val = car(l);

if (globalTrace)
    snprintf(caller, 1024, "from q/lists.qon:337");
        if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);

        if ( isList(val)) {
if (globalTrace)
    snprintf(caller, 1024, "from q/lists.qon:339");
          if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);

          newLine(indent);

if (globalTrace)
    snprintf(caller, 1024, "from q/lists.qon:340");
          if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);

          printf("%s", openBrace());

if (globalTrace)
    snprintf(caller, 1024, "from q/lists.qon:341");
          if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);

          displayList(car(l), add1(indent), true);

if (globalTrace)
    snprintf(caller, 1024, "from q/lists.qon:342");
          if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);

          printf("%s", closeBrace());

if (globalTrace)
    snprintf(caller, 1024, "from q/lists.qon:343");
          if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);
...
if (globalTrace)
    snprintf(caller, 1024, "from q/lists.qon:348");
          if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);
...
if (globalTrace)
    snprintf(caller, 1024, "from q/lists.qon:350");
      if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);
...
//Building function StringListJoinRec from file q/lists.qon, line: 354
...
if (globalTrace)
    printf("Leaving StringListJoinRec\n");

}


//Building function StringListJoin from file q/lists.qon, line: 377
...
if (globalTrace)
    printf("Leaving StringListJoin\n");

}


//Building function ListToBoxString from file q/lists.qon, line: 387
...
//Building function ListToString from file q/lists.qon, line: 392
...
if (globalTrace)
    printf("Leaving ListToString\n");

}


//Building function listReverse from file q/lists.qon, line: 432
...
//Building function inList from file q/lists.qon, line: 438
...
//Building function equalList from file q/lists.qon, line: 448
...
//Building function reverseRec from file q/lists.qon, line: 471
...
//Building function reverseList from file q/lists.qon, line: 478
...
//Building function flatten from file q/lists.qon, line: 483
...
//Building function macrolist from file q/macros.qon, line: 83
...
//Building function tern from file q/base.qon, line: 37
...
//Building function ternString from file q/base.qon, line: 41
...
if (globalTrace)
    printf("Leaving ternString\n");

}


//Building function ternList from file q/base.qon, line: 45
...
//Building function newVoid from file q/base.qon, line: 50
...
//Building function stackDump from file q/base.qon, line: 59
...
//Building function nop from file q/base.qon, line: 64
...
//Building function equalBox from file q/base.qon, line: 67
...
//Building function openBrace from file q/base.qon, line: 88
...
//Building function closeBrace from file q/base.qon, line: 89
...
//Building function boxType from file q/base.qon, line: 94

char* boxType(box b) {
  
if (globalTrace)
    printf("boxType at q/base.qon:94 (%s)\n", caller);
...
//Building function makeBox from file q/base.qon, line: 98

box makeBox() {
  box b = NULL;

if (globalTrace)
    printf("makeBox at q/base.qon:98 (%s)\n", caller);
...
//Building function makePair from file q/base.qon, line: 112

pair makePair() {
  
if (globalTrace)
    printf("makePair at q/base.qon:112 (%s)\n", caller);

if (globalTrace)
    snprintf(caller, 1024, "from q/base.qon:114");
  if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);
...
//Building function boxString from file q/base.qon, line: 117
...
//Building function boxSymbol from file q/base.qon, line: 127
...
//Building function boxBool from file q/base.qon, line: 136
...
//Building function boxInt from file q/base.qon, line: 145
...
//Building function assertType from file q/base.qon, line: 154
...
//Building function unBoxString from file q/base.qon, line: 169
...
//Building function unBoxSymbol from file q/base.qon, line: 172

char* unBoxSymbol(box b) {
  
if (globalTrace)
    printf("unBoxSymbol at q/base.qon:172 (%s)\n", caller);
...
//Building function unBoxBool from file q/base.qon, line: 173
...
//Building function unBoxInt from file q/base.qon, line: 174
...
//Building function stringify_rec from file q/base.qon, line: 176
...
//Building function stringify from file q/base.qon, line: 185
...
//Building function hasTag from file q/base.qon, line: 220
...
//Building function getTag from file q/base.qon, line: 227
...
//Building function getTagFail from file q/base.qon, line: 239
...
//Building function assocExists from file q/base.qon, line: 249
...
//Building function assocFail from file q/base.qon, line: 257
...
//Building function assocPanic from file q/base.qon, line: 264
...
//Building function setTag from file q/base.qon, line: 275
...
//Building function locPanic from file q/base.qon, line: 281
...
//Building function truthy from file q/base.qon, line: 287
...
//Building function isNotFalse from file q/base.qon, line: 292
...
//Building function toStr from file q/base.qon, line: 299
...
//Building function listLast from file q/base.qon, line: 303
...
//Building function newLine from file q/base.qon, line: 310

void newLine(int indent) {
  
if (globalTrace)
    printf("newLine at q/base.qon:310 (%s)\n", caller);
...
//Building function printIndent from file q/base.qon, line: 314
...
//Building function stringIndent from file q/base.qon, line: 321
...
if (globalTrace)
    printf("Leaving stringIndent\n");

}


//Building function argList from file q/base.qon, line: 329
...
//Building function tron from file q/base.qon, line: 339
...
//Building function troff from file q/base.qon, line: 340
...
//Building function stron from file q/base.qon, line: 341
...
//Building function stroff from file q/base.qon, line: 342
...
//Building function StackTraceMove from file q/base.qon, line: 346

void StackTraceMove(char* direction, char* filename, char* fname, char* line) {
  
if (globalTrace)
    printf("StackTraceMove at q/base.qon:346 (%s)\n", caller);
...
if (globalTrace)
    printf("Leaving StackTraceMove\n");

}


//Building function StackTracePrint from file q/base.qon, line: 354

void StackTracePrint() {
  
if (globalTrace)
    printf("StackTracePrint at q/base.qon:354 (%s)\n", caller);
...
if (globalTrace)
    printf("Leaving StackTracePrint\n");

}


//Building function StackTracePrintHelper from file q/base.qon, line: 362
...
if (globalTrace)
    printf("StackTracePrintHelper at q/base.qon:362 (%s)\n", caller);
...
if (globalTrace)
    snprintf(caller, 1024, "from q/base.qon:379");
    if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);
...
if (globalTrace)
    printf("Leaving StackTracePrintHelper\n");

}


//Building function NoStackTrace_list from file q/base.qon, line: 385

list NoStackTrace_list() {
  
if (globalTrace)
    printf("NoStackTrace_list at q/base.qon:385 (%s)\n", caller);

if (globalTrace)
    snprintf(caller, 1024, "from q/base.qon:387");
  if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);
...
if (globalTrace)
    printf("Leaving NoStackTrace_list\n");

}


//Building function NoTrace_list from file q/base.qon, line: 390
...
if (globalTrace)
    snprintf(caller, 1024, "from q/shims/ansi3.qon:31");
  if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);
...
//Building function sub from file q/shims/ansi3.qon, line: 33
...
//Building function mult from file q/shims/ansi3.qon, line: 37
...
//Building function greaterthan from file q/shims/ansi3.qon, line: 41
...
//Building function subf from file q/shims/ansi3.qon, line: 45
...
//Building function multf from file q/shims/ansi3.qon, line: 49
...
//Building function greaterthanf from file q/shims/ansi3.qon, line: 53
...
//Building function equal from file q/shims/ansi3.qon, line: 57
...
//Building function equalString from file q/shims/ansi3.qon, line: 61

int equalString(char* a, char* b) {
  
if (globalTrace)
    printf("equalString at q/shims/ansi3.qon:61 (%s)\n", caller);

if (globalTrace)
    snprintf(caller, 1024, "from q/shims/ansi3.qon:63");
  if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);
...
//Building function string_length from file q/shims/ansi3.qon, line: 65

int string_length(char* s) {
  
if (globalTrace)
    printf("string_length at q/shims/ansi3.qon:65 (%s)\n", caller);

if (globalTrace)
    snprintf(caller, 1024, "from q/shims/ansi3.qon:67");
  if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);
...
//Building function setSubString from file q/shims/ansi3.qon, line: 69
...
//Building function sub_string from file q/shims/ansi3.qon, line: 75
...
//Building function stringConcatenate from file q/shims/ansi3.qon, line: 82
...
//Building function intToString from file q/shims/ansi3.qon, line: 91
...
//Building function gc_malloc from file q/shims/ansi3.qon, line: 99
...
//Building function makeArray from file q/shims/ansi3.qon, line: 104
...
//Building function at from file q/shims/ansi3.qon, line: 110
...
//Building function setAt from file q/shims/ansi3.qon, line: 115
...
//Building function setCharAt from file q/shims/ansi3.qon, line: 120
...
//Building function read_file from file q/shims/ansi3.qon, line: 125
...
//Building function write_file from file q/shims/ansi3.qon, line: 145
...
//Building function getStringArray from file q/shims/ansi3.qon, line: 156
...
//Building function programArgs from file q/shims/ansi3.qon, line: 160
...
//Building function programArgsCount from file q/shims/ansi3.qon, line: 165
...
//Building function main from file q/shims/ansi3.qon, line: 171

int main(int argc, char** argv) {
  
if (globalTrace)
    printf("main at q/shims/ansi3.qon:171 (%s)\n", caller);
...
//Building function character from file q/shims/ansi3.qon, line: 179
...
//Building function displays from file q/shims/ansi3.qon, line: 194
...
//Building function start from file compiler.qon, line: 5
