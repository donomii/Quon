...
void node2FunctionArgs(list tree);
void node2Expression(list tree, int indent);
void node2RecurList(list expr, int indent);
void node2If(list node, int indent, char* functionName);
void node2SetStruct(list node, int indent);
void node2Set(list node, int indent);
void node2Return(list node, int indent);
void node2Statement(list node, int indent, char* functionName);
void node2Body(list tree, int indent, char* functionName);
void node2Declarations(list decls, int indent);
void node2Function(list node);
void node2Functions(list tree);
void node2Includes(list nodes);
void node2Types(list nodes);
...
if (globalTrace)
    printf("node2Expression at q/node2.qon:16 (%s)\n", caller);

  StackTraceMove("in", "q/node2.qon", "node2Expression", "16" );
...
if (globalTrace)
    snprintf(caller, 1024, "from q/node2.qon:25");
        if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);
...
if (globalTrace)
    snprintf(caller, 1024, "from q/node2.qon:30");
        if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);
...
if (globalTrace)
    snprintf(caller, 1024, "from q/node2.qon:36");
          if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);
...
if (globalTrace)
    snprintf(caller, 1024, "from q/node2.qon:41");
              if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);
...
if (globalTrace)
    snprintf(caller, 1024, "from q/node2.qon:43");
              if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);

              printf(" %s ", stringify(second(tree)));

if (globalTrace)
    snprintf(caller, 1024, "from q/node2.qon:44");
              if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);
...
if (globalTrace)
    snprintf(caller, 1024, "from q/node2.qon:52");
    if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);
...
if (globalTrace)
    printf("node2RecurList at q/node2.qon:56 (%s)\n", caller);

  StackTraceMove("in", "q/node2.qon", "node2RecurList", "56" );

if (globalTrace)
    snprintf(caller, 1024, "from q/node2.qon:58");
  if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);
...
if (globalTrace)
    snprintf(caller, 1024, "from q/node2.qon:61");
    if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);
...
if (globalTrace)
    ...
    if ( isNil(cdr(expr))) {
if (globalTrace)
    snprintf(caller, 1024, "from q/node2.qon:63");
      if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);
...
if (globalTrace)
    snprintf(caller, 1024, "from q/node2.qon:64");
      if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);
...
if (globalTrace)
    printf("node2If at q/node2.qon:66 (%s)\n", caller);

  StackTraceMove("in", "q/node2.qon", "node2If", "66" );

if (globalTrace)
    snprintf(caller, 1024, "from q/node2.qon:68");
  if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);

  newLine(indent);

if (globalTrace)
    snprintf(caller, 1024, "from q/node2.qon:69");
  if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);
...
if (globalTrace)
    snprintf(caller, 1024, "from q/node2.qon:76");
  if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);

  newLine(indent);

if (globalTrace)
    snprintf(caller, 1024, "from q/node2.qon:77");
  if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);
...
if (globalTrace)
    printf("node2SetStruct at q/node2.qon:79 (%s)\n", caller);

  StackTraceMove("in", "q/node2.qon", "node2SetStruct", "79" );
...
if (globalTrace)
    printf("node2Set at q/node2.qon:86 (%s)\n", caller);

  StackTraceMove("in", "q/node2.qon", "node2Set", "86" );
...
if (globalTrace)
    snprintf(caller, 1024, "from q/node2.qon:90");
  if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);
...
if (globalTrace)
    printf("node2Return at q/node2.qon:93 (%s)\n", caller);

  StackTraceMove("in", "q/node2.qon", "node2Return", "93" );
...
if (globalTrace)
    snprintf(caller, 1024, "from q/node2.qon:97");
    if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);
...
if (globalTrace)
    snprintf(caller, 1024, "from q/node2.qon:99");
    if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);

    printf("return ");

if (globalTrace)
    snprintf(caller, 1024, "from q/node2.qon:100");
    if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);
...
if (globalTrace)
    printf("node2Statement at q/node2.qon:102 (%s)\n", caller);

  StackTraceMove("in", "q/node2.qon", "node2Statement", "102" );

if (globalTrace)
    snprintf(caller, 1024, "from q/node2.qon:104");
  if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);
...
if (globalTrace)
    snprintf(caller, 1024, "from q/node2.qon:107");
    if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);

    if ( equalBox(boxString("set-struct"), first(node))) {
if (globalTrace)
    snprintf(caller, 1024, "from q/node2.qon:108");
      if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);
...
if (globalTrace)
    snprintf(caller, 1024, "from q/node2.qon:111");
        if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);
...
if (globalTrace)
    printf("node2Body at q/node2.qon:120 (%s)\n", caller);

  StackTraceMove("in", "q/node2.qon", "node2Body", "120" );

if (globalTrace)
    snprintf(caller, 1024, "from q/node2.qon:122");
  if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);

  if ( isEmpty(tree)) {
if (globalTrace)
    snprintf(caller, 1024, "from q/node2.qon:123");
    if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);
...
if (globalTrace)
    snprintf(caller, 1024, "from q/node2.qon:126");
    if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);
...
if (globalTrace)
    printf("node2Declarations at q/node2.qon:129 (%s)\n", caller);

  StackTraceMove("in", "q/node2.qon", "node2Declarations", "129" );
...
if (globalTrace)
  ...
  if ( isEmpty(decls)) {
if (globalTrace)
    snprintf(caller, 1024, "from q/node2.qon:132");
    if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);
...
if (globalTrace)
    snprintf(caller, 1024, "from q/node2.qon:135");
    if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);
...
if (globalTrace)
    snprintf(caller, 1024, "from q/node2.qon:138");
    if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);

    printf(";\n");

if (globalTrace)
    snprintf(caller, 1024, "from q/node2.qon:139");
    if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);
...
if (globalTrace)
    printf("node2Function at q/node2.qon:141 (%s)\n", caller);

  StackTraceMove("in", "q/node2.qon", "node2Function", "141" );
...
if (globalTrace)
    snprintf(caller, 1024, "from q/node2.qon:149");
    if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);

    printf("function %s(", stringify(node2FuncMap(second(node))));

if (globalTrace)
    snprintf(caller, 1024, "from q/node2.qon:150");
    if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);

    node2FunctionArgs(third(node));

if (globalTrace)
    snprintf(caller, 1024, "from q/node2.qon:151");
    if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);

    printf(") {");

if (globalTrace)
    snprintf(caller, 1024, "from q/node2.qon:152");
    if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);
...
if (globalTrace)
    printf("node2Functions at q/node2.qon:157 (%s)\n", caller);

  StackTraceMove("in", "q/node2.qon", "node2Functions", "157" );
...
if (globalTrace)
    printf("node2Includes at q/node2.qon:165 (%s)\n", caller);

  StackTraceMove("in", "q/node2.qon", "node2Includes", "165" );
...
if (globalTrace)
    snprintf(caller, 1024, "from q/node2.qon:171");
  if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);
...
if (globalTrace)
    snprintf(caller, 1024, "from q/node2.qon:173");
  if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);
...
if (globalTrace)
    snprintf(caller, 1024, "from q/node2.qon:175");
  if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);
...
if (globalTrace)
    snprintf(caller, 1024, "from q/node2.qon:177");
  if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);

  printf("function cformat(fmt, ...args) {\n");

if (globalTrace)
    snprintf(caller, 1024, "from q/node2.qon:178");
  if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);
...
if (globalTrace)
    snprintf(caller, 1024, "from q/node2.qon:181");
  if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);

  printf("  for (let pos = 0; pos < fmt.length; pos++) {\n");

if (globalTrace)
    snprintf(caller, 1024, "from q/node2.qon:182");
  if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);

  printf("    let ch = fmt[pos];\n");

if (globalTrace)
    snprintf(caller, 1024, "from q/node2.qon:183");
  if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);
...
if (globalTrace)
    snprintf(caller, 1024, "from q/node2.qon:191");
  if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);
...
if (globalTrace)
    snprintf(caller, 1024, "from q/node2.qon:194");
  if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);
...
if (globalTrace)
    snprintf(caller, 1024, "from q/node2.qon:198");
  if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);

  printf("    } else {\n");

if (globalTrace)
    snprintf(caller, 1024, "from q/node2.qon:199");
  if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);

  printf("      out += ch;\n");

if (globalTrace)
    snprintf(caller, 1024, "from q/node2.qon:200");
  if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);

  printf("    }\n");

if (globalTrace)
    snprintf(caller, 1024, "from q/node2.qon:201");
  if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);
...
if (globalTrace)
    snprintf(caller, 1024, "from q/node2.qon:203");
  if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);

  printf("}\n");

if (globalTrace)
    snprintf(caller, 1024, "from q/node2.qon:204");
  if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);

  printf("function printf(fmt, ...args) { process.stdout.write(cformat(fmt, ...args)); }\n");

if (globalTrace)
    snprintf(caller, 1024, "from q/node2.qon:205");
  if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);
...
if (globalTrace)
    printf("node2Types at q/node2.qon:207 (%s)\n", caller);

  StackTraceMove("in", "q/node2.qon", "node2Types", "207" );

if (globalTrace)
    snprintf(caller, 1024, "from q/node2.qon:209");
  if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);
...
if (globalTrace)
    snprintf(caller, 1024, "from q/node2.qon:211");
    if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);
...
if (globalTrace)
    printf("node2FuncMap at q/node2.qon:213 (%s)\n", caller);

  StackTraceMove("in", "q/node2.qon", "node2FuncMap", "213" );
...
if (globalTrace)
    snprintf(caller, 1024, "from q/node2.qon:217");
    if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);
...
if (globalTrace)
    snprintf(caller, 1024, "from q/node2.qon:226");
    if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);

    if ( truthy(assoc(stringify(aSym), symMap))) {
if (globalTrace)
    snprintf(caller, 1024, "from q/node2.qon:227");
      if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);
...
if (globalTrace)
    snprintf(caller, 1024, "from q/node2.qon:228");
      if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);
...
if (globalTrace)
    snprintf(caller, 1024, "from q/node2.qon:229");
    if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);
...
if (globalTrace)
    printf("node2MainEntry at q/node2.qon:231 (%s)\n", caller);

  StackTraceMove("in", "q/node2.qon", "node2MainEntry", "231" );

if (globalTrace)
    snprintf(caller, 1024, "from q/node2.qon:233");
  if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);

  printf("\n// Main entry point\n");

if (globalTrace)
    snprintf(caller, 1024, "from q/node2.qon:234");
  if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);

  printf("globalArgs = [\"fixmeprogname\", ...process.argv.slice(2)];\n");

if (globalTrace)
    snprintf(caller, 1024, "from q/node2.qon:235");
  if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);

  printf("globalArgsCount = globalArgs.length;\n");

if (globalTrace)
    snprintf(caller, 1024, "from q/node2.qon:236");
  if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);
...
if (globalTrace)
    printf("node2Compile at q/node2.qon:238 (%s)\n", caller);

  StackTraceMove("in", "q/node2.qon", "node2Compile", "238" );
...
if (globalTrace)
    snprintf(caller, 1024, "from q/node2.qon:247");
  if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);

  tree = macrowalk(tree);

if (globalTrace)
    snprintf(caller, 1024, "from q/node2.qon:248");
  if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);

  replace = cons(boxSymbol("fprintf"), cons(boxSymbol("stderr"), NULL));

if (globalTrace)
    snprintf(caller, 1024, "from q/node2.qon:249");
  if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);
...
if (globalTrace)
    snprintf(caller, 1024, "from q/node2.qon:251");
  if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);

  node2Includes(cdr(first(tree)));

if (globalTrace)
    snprintf(caller, 1024, "from q/node2.qon:252");
  if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);

  node2Types(cdr(second(tree)));

if (globalTrace)
    snprintf(caller, 1024, "from q/node2.qon:253");
  if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);
...
if (globalTrace)
    printf("ansi3Declarations at q/ansi3.qon:222 (%s)\n", caller);

  StackTraceMove("in", "q/ansi3.qon", "ansi3Declarations", "222" );
...
if (globalTrace)
    printf("ansi3Function at q/ansi3.qon:236 (%s)\n", caller);

  StackTraceMove("in", "q/ansi3.qon", "ansi3Function", "236" );
...
if (globalTrace)
    printf("ansi3ForwardDeclaration at q/ansi3.qon:276 (%s)\n", caller);

  StackTraceMove("in", "q/ansi3.qon", "ansi3ForwardDeclaration", "276" );
...
if (globalTrace)
    printf("ansi3ForwardDeclarations at q/ansi3.qon:286 (%s)\n", caller);

  StackTraceMove("in", "q/ansi3.qon", "ansi3ForwardDeclarations", "286" );
...
if (globalTrace)
    printf("ansi3Functions at q/ansi3.qon:292 (%s)\n", caller);

  StackTraceMove("in", "q/ansi3.qon", "ansi3Functions", "292" );
...
if (globalTrace)
    printf("ansi3Includes at q/ansi3.qon:298 (%s)\n", caller);

  StackTraceMove("in", "q/ansi3.qon", "ansi3Includes", "298" );
...
if (globalTrace)
    printf("ansi3TypeDecl at q/ansi3.qon:306 (%s)\n", caller);

  StackTraceMove("in", "q/ansi3.qon", "ansi3TypeDecl", "306" );
...
if (globalTrace)
    snprintf(caller, 1024, "from q/ansi3.qon:311");
    if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);
...
if (globalTrace)
    printf("ansi3StructComponents at q/ansi3.qon:323 (%s)\n", caller);

  StackTraceMove("in", "q/ansi3.qon", "ansi3StructComponents", "323" );
...
if (globalTrace)
    printf("ansi3Struct at q/ansi3.qon:329 (%s)\n", caller);

  StackTraceMove("in", "q/ansi3.qon", "ansi3Struct", "329" );
...
if (globalTrace)
    printf("ansi3TypeMap at q/ansi3.qon:332 (%s)\n", caller);

  StackTraceMove("in", "q/ansi3.qon", "ansi3TypeMap", "332" );
...
if (globalTrace)
    snprintf(caller, 1024, "from q/ansi3.qon:340");
    if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);
...
if (globalTrace)
    printf("ansi3FuncMap at q/ansi3.qon:342 (%s)\n", caller);

  StackTraceMove("in", "q/ansi3.qon", "ansi3FuncMap", "342" );

if (globalTrace)
    snprintf(caller, 1024, "from q/ansi3.qon:344");
  if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);

  if ( equalString("symbol", boxType(aSym))) {
if (globalTrace)
    snprintf(caller, 1024, "from q/ansi3.qon:346");
    if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);
...
if (globalTrace)
    printf("ansi3Type at q/ansi3.qon:373 (%s)\n", caller);

  StackTraceMove("in", "q/ansi3.qon", "ansi3Type", "373" );
...
if (globalTrace)
    printf("ansi3Types at q/ansi3.qon:383 (%s)\n", caller);

  StackTraceMove("in", "q/ansi3.qon", "ansi3Types", "383" );
...
if (globalTrace)
    printf("ansi3Compile at q/ansi3.qon:393 (%s)\n", caller);

  StackTraceMove("in", "q/ansi3.qon", "ansi3Compile", "393" );
...
if (globalTrace)
    snprintf(caller, 1024, "from q/ansi3.qon:425");
  if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);
...
if (globalTrace)
    snprintf(caller, 1024, "from q/newparser.qon:72");
    if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);
...
if (globalTrace)
    printf("loadIncludes at q/newparser.qon:79 (%s)\n", caller);

  StackTraceMove("in", "q/newparser.qon", "loadIncludes", "79" );

if (globalTrace)
    snprintf(caller, 1024, "from q/newparser.qon:87");
  if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);
...
if (globalTrace)
    printf("buildProg at q/newparser.qon:111 (%s)\n", caller);

  StackTraceMove("in", "q/newparser.qon", "buildProg", "111" );
...
if (globalTrace)
    snprintf(caller, 1024, "from q/newparser.qon:114");
  if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);
...
if (globalTrace)
    printf("isCloseBrace at q/compiler.qon:182 (%s)\n", caller);

  StackTraceMove("in", "q/compiler.qon", "isCloseBrace", "182" );
...
if (globalTrace)
    snprintf(caller, 1024, "from q/compiler.qon:187");
    if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);
...
if (globalTrace)
    printf("skipList at q/compiler.qon:192 (%s)\n", caller);

  StackTraceMove("in", "q/compiler.qon", "skipList", "192" );
...
if (globalTrace)
  ...
  if ( isEmpty(l)) {
if (globalTrace)
    snprintf(caller, 1024, "from q/compiler.qon:195");
    if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);
...
if (globalTrace)
    snprintf(caller, 1024, "from q/compiler.qon:198");
    if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);
...
if (globalTrace)
    printf("makeNode at q/compiler.qon:214 (%s)\n", caller);

  StackTraceMove("in", "q/compiler.qon", "makeNode", "214" );

if (globalTrace)
    snprintf(caller, 1024, "from q/compiler.qon:216");
  if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);
...
if (globalTrace)
    printf("addToNode at q/compiler.qon:230 (%s)\n", caller);

  StackTraceMove("in", "q/compiler.qon", "addToNode", "230" );

if (globalTrace)
    snprintf(caller, 1024, "from q/compiler.qon:232");
  if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);
...
if (globalTrace)
    printf("makeStatementNode at q/compiler.qon:235 (%s)\n", caller);

  StackTraceMove("in", "q/compiler.qon", "makeStatementNode", "235" );
...
if (globalTrace)
    printf("declarationsof at q/compiler.qon:240 (%s)\n", caller);

  StackTraceMove("in", "q/compiler.qon", "declarationsof", "240" );
...
if (globalTrace)
    printf("codeof at q/compiler.qon:243 (%s)\n", caller);

  StackTraceMove("in", "q/compiler.qon", "codeof", "243" );
...
if (globalTrace)
    printf("functionNameof at q/compiler.qon:246 (%s)\n", caller);

  StackTraceMove("in", "q/compiler.qon", "functionNameof", "246" );
...
if (globalTrace)
    printf("nodeof at q/compiler.qon:249 (%s)\n", caller);

  StackTraceMove("in", "q/compiler.qon", "nodeof", "249" );
...
if (globalTrace)
    snprintf(caller, 1024, "from q/compiler.qon:254");
    if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);
...
if (globalTrace)
    printf("lineof at q/compiler.qon:257 (%s)\n", caller);

  StackTraceMove("in", "q/compiler.qon", "lineof", "257" );
...
if (globalTrace)
    printf("subnameof at q/compiler.qon:262 (%s)\n", caller);

  StackTraceMove("in", "q/compiler.qon", "subnameof", "262" );
...
if (globalTrace)
    printf("nameof at q/compiler.qon:265 (%s)\n", caller);

  StackTraceMove("in", "q/compiler.qon", "nameof", "265" );
...
if (globalTrace)
    printf("childrenof at q/compiler.qon:268 (%s)\n", caller);

  StackTraceMove("in", "q/compiler.qon", "childrenof", "268" );
...
if (globalTrace)
    printf("isNode at q/compiler.qon:272 (%s)\n", caller);

  StackTraceMove("in", "q/compiler.qon", "isNode", "272" );
...
if (globalTrace)
    snprintf(caller, 1024, "from q/compiler.qon:283");
        if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);
...
if (globalTrace)
    printf("isLeaf at q/compiler.qon:288 (%s)\n", caller);

  StackTraceMove("in", "q/compiler.qon", "isLeaf", "288" );
...
if (globalTrace)
    printf("noStackTrace at q/compiler.qon:294 (%s)\n", caller);

  StackTraceMove("in", "q/compiler.qon", "noStackTrace", "294" );
...
if (globalTrace)
    printf("treeCompile at q/compiler.qon:326 (%s)\n", caller);

  StackTraceMove("in", "q/compiler.qon", "treeCompile", "326" );
...
if (globalTrace)
    snprintf(caller, 1024, "from q/compiler.qon:337");
    if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);
...
if (globalTrace)
    printf("mergeIncludes at q/compiler.qon:341 (%s)\n", caller);

  StackTraceMove("in", "q/compiler.qon", "mergeIncludes", "341" );
...
if (globalTrace)
    printf("merge_recur at q/compiler.qon:348 (%s)\n", caller);

  StackTraceMove("in", "q/compiler.qon", "merge_recur", "348" );
...
if (globalTrace)
    printf("mergeInclude at q/compiler.qon:356 (%s)\n", caller);

  StackTraceMove("in", "q/compiler.qon", "mergeInclude", "356" );

if (globalTrace)
    snprintf(caller, 1024, "from q/compiler.qon:371");
  if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);
...
if (globalTrace)
    snprintf(caller, 1024, "from q/compiler.qon:378");
    if (globalStepTrace) printf("StepTrace %s:%d\n", __FILE__, __LINE__);
